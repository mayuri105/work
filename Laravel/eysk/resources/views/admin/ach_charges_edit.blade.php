		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('update-ach-charge-amount') }}" method="POST" style="margin-top: -20px;">
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="ach_charges_amount" placeholder="Enter Ach Charge Amount" value="{{ $editAchChargeAmountData->ach_charges_amount }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control start_date" name="start_date" value="{{ date("d-m-Y",strtotime($editAchChargeAmountData->start_date)) }}" placeholder="Enter Start Date">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control end_date" name="end_date" value="@if($editAchChargeAmountData->end_date !='0000-00-00'){{ date("d-m-Y",strtotime($editAchChargeAmountData->end_date)) }} @endif" placeholder="Enter End Date">
						...
						<input type="hidden" name="editId" value="{{ $editAchChargeAmountData->ach_charge_id }}">
