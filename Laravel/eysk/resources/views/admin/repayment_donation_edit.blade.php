		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('update-repayment-donation') }}" method="POST" style="margin-top: -5px;">
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control start_date" name="start_date" value="{{ date("d-m-Y",strtotime($editRepaymentDonation->start_date)) }}" placeholder="ENTER START DATE">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control end_date" name="end_date" value="@if($editRepaymentDonation->end_date !='0000-00-00'){{ date("d-m-Y",strtotime($editRepaymentDonation->end_date)) }} @endif" placeholder="ENTER END DATE">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="region_repayment_amount" placeholder="ENTER REGION REPAYMENT AMOUNT" value="{{ $editRepaymentDonation['region_repayment_amount'] }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="yuva_mandal_repayment_amount" placeholder="ENTER YUVA MANDAL REPAYMENT AMOUNT" value="{{ $editRepaymentDonation['yuva_mandal_repayment_amount'] }}">
						...
						<input type="hidden" name="editId" value="{{ $editRepaymentDonation['repayment_donations_id'] }}">
