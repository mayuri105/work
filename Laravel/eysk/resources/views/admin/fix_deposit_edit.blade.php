			...
			<div class="col-lg-12">
				...
				<div class="kt-portlet">
					...
					<div class="mtt-body">
						...
						<form action="{{ route('update-fix-deposit') }}" enctype="multipart/form-data" method="POST">
							...
							<div class="kt-portlet sahyognidhi-mtt">
								...
								<div class="row">
									...
									<div class="col-sm-12">	
										...
										<div class="col-lg-2" style="margin-left: -150px;">
														<input type="text" id="date" name="date" class="form-control" placeholder="ENTER DATE" value="{{ date('d-m-Y',strtotime($editFixDepositData['date'])) }}">
													...
													<div class="col-lg-2">
														...
														<input type="text" id="fix_deposit_no" name="fix_deposit_no" class="form-control" placeholder="ENTER FIX DEPOSIT NUMBER" value="{{ $editFixDepositData['fix_deposit_no'] }}" readonly="">
    										...
    										@foreach($ledgeraccounts as $ledgeraccountss)
    											<option  @if($editFixDepositData->fk_ledger_account_id == $ledgeraccountss->ledger_account_id) selected @endif value="{{ $ledgeraccountss->ledger_account_id }}">{{ $ledgeraccountss->legder_name }}</option>
    										@endforeach
    								...
    								<div class="col-lg-2">
    									<label>Amount</label>	
    									<input type="text" class="form-control amount_main"  id="amount_main" name="amount_main" placeholder="ENTER AMOUNT" value="{{ $editFixDepositData->amount_main }}">
    									...
    									@endif
									     ...
									     <div class="form-group1 m-form__group1 row details">
									   	...
									   	<?php $i= 1;?>				
									     @foreach($FixDepositdetail as $FixDepositdetails)
                                    ...
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="fd_certificate_no" name="fd_certificate_no[]" class="form-control" placeholder="ENTER FIX DEPOSIT CERTIFICATE NUMBER" value="{{ $FixDepositdetails->fd_certificate_no }}">
                                ...
                                <div class="form-group1 m-form__group1 row" style="padding-left: 10px;">	
									...
									<span class="text-danger">*</span></label>
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="fd_amount" name="fd_amount[]" class="form-control fd_amount" placeholder="ENTER FIX DEPOSIT AMOUNT" value="{{ $FixDepositdetails->fd_amount }}">
                                ...
                                <div class="form-group1 m-form__group1 row" style="padding-left: 10px;">	
									...
									<span class="text-danger">*</span></label>
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="fd_percentage" name="fd_percentage[]" class="form-control" placeholder="ENTER FIX DEPOSIT PERCENTAGE" value="{{ $FixDepositdetails->fd_percentage }}">
                                ...
                                <div class="form-group1 m-form__group1 row" style="padding-left: 10px;">	
									...
									<span class="text-danger">*</span></label>
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="fd_maturity_date" name="fd_maturity_date[]" class="form-control" placeholder="ENTER FIX DEPOSIT MATURITY DATE" value="{{ date('d-m-Y',strtotime($FixDepositdetails['fd_maturity_date'])) }}">
                                ...
                                <div class="form-group1 m-form__group1 row" style="padding-left: 10px;">	
									...
									<span class="text-danger">*</span></label>
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="fd_maturity_amount" name="fd_maturity_amount[]" class="form-control" placeholder="ENTER FIX DEPOSIT MATURITY AMOUNT" value="{{ $FixDepositdetails->fd_maturity_amount }}">
                                ...
                                <div class="form-group1 m-form__group1 row" style="padding-left: 10px;">	
									...
									<span class="text-danger">*</span></label>
                                    <div class="col-lg-4" style="margin-left: -95px;">
                                        <input type="text" id="narration" name="narration[]" class="form-control" placeholder="ENTER NARRATION" value="{{ $FixDepositdetails->narration }}">
										...
										<input type="hidden" name="editId" value="{{ $editFixDepositData['fix_deposit_id'] }}">									<input type="submit" name="submit" value="  Edit  " class="btn btn-brand btn-warning btn-elevate btn-icon-sm">
