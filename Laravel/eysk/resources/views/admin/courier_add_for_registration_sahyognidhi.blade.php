								...
								<div id="London" class="w3-container city">
									<div class="Half-section-details">
										...
										<div class="form-group1 m-form__group1 row">	
											...
											<div class="col-lg-9">
												<select class="form-control kt-select2" id="fk_registration_id" name="fk_registration_id" onchange="getDataByYskId(this.value)">
													<option>Select YSK</option>
													@if($yskMember['ysk_id'] != '')
													  <option value="{{ $yskMember['ysk_id'] }}" selected>{{ $yskMember['hidden_name_as_per_yuva_sangh_org'] }}(PreYsk- {{ $yskMember['ysk_id'] }})</option>	
													 @elseif($yskMember['ysk_id'] == '')
													 	<option value="{{ $yskMember['pre_ysk_id'] }}" selected>{{ $yskMember['hidden_name_as_per_yuva_sangh_org'] }}(PreYsk- {{ $yskMember['pre_ysk_id'] }})</option>
													@endif									
											...
											<div class="col-lg-9">
												<select class="form-control kt-select2" id="fk_registration_id" name="fk_registration_id" onchange="getDataByYskId(this.value)">
													<option>Select YSK</option>
													  ...
													  <option value="{{ $sahyognidhiRequestData['fk_ysk_id'] }}" selected>{{ $sahyognidhiRequestData['name_as_per_yuvasangh_org'] }}(PreYsk- {{ $sahyognidhiRequestData['fk_ysk_id'] }})</option>						
										...
										<div class="form-group1 m-form__group1 row">	
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" placeholder="Enter Name" id="name_as_per_yuva_sangh_org" aria-describedby="emailHelp" name="name_as_per_yuva_sangh_org" value="@if($sahyognidhiRequestData != ''){{ $sahyognidhiRequestData['name_as_per_yuvasangh_org'] }} @elseif($yskMember != '') {{ $yskMember['hidden_name_as_per_yuva_sangh_org'] }} @endif">
										...
										<div class="form-group1 m-form__group1 row">	
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" placeholder="Enter Contact Number" id="phone_number" aria-describedby="emailHelp" name="phone_number" value="@if($sahyognidhiRequestData != ''){{ $sahyognidhiRequestData['first_phone_number'] }} @elseif($yskMember != '') {{ $yskMember['phone_number_first'] }} @endif">
											...
											<input type="hidden" name="courier_for" value="@if($sahyognidhiRequestData != '') Sahyognidhi Request @elseif($yskMember['courier_for'] == 'Registration') 55 Years @elseif($yskMember != '') Registration  @endif">
