		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('update-division') }}" method="POST" style="margin-top: -5px;">
							...
							<div class="kt-form__section kt-form__section--first">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<select class="form-control m-input" name="fk_region_id" id="fk_region_id">
											...
											<option @if($editDivisionData->fk_region_id == $regions->region_id) selected @endif value="{{ $regions->region_id }}">{{ $regions->region_name }}({{ $regions->region_code }})</option>
											@endforeach
										</select>
								...
								<div class="form-group1 m-form__group1 row details">	
									...
									<div class="registration-list-modal" style="margin-left: 18px;">
										<div class="row">	
											<div class="col-lg-10">	
												<?php $expl = explode(',', $editDivisionData['division_name']) ?>
												 @for($i=0;$i<count($expl);$i++)
													<input type="text" class="form-control" name="division_name[]" value="{{ $expl[$i] }}" placeholder="ENTER DIVISION NAME" style="text-transform: uppercase;">
													<br>
												@endfor
						...
						<input type="hidden" name="editId" value="{{ $editDivisionData['division_id'] }}">
