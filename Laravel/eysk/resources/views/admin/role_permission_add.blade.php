		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('save-role-permission') }}" method="POST" style="margin-top: -5px;">
											...
											<div class="m-demo__preview m-demo__preview--badge p-4">
												...
												<div class="kt-checkbox-inline">
													...
													<label class="kt-checkbox m-checkbox" cheched="">
														<input type="checkbox" name="page_slugs[]" value="{{ $valueModulePageSlug['page_id'] }}" onchange="checkAll({{ $valueModulePageSlug['page_id'] }})" id="pages{{ $valueModulePageSlug['page_id'] }}" class="add_class_{{ $valueModulePageSlug['page_id'] }} kt-checkbox kt-checkbox--single kt-checkbox--solid"> {{ $valueModulePageSlug['page_slug'] }}
														<span></span>
													</label>
													@else
													<label class="kt-checkbox m-checkbox" cheched="">
														<input type="checkbox" name="page_slugs[]" value="{{ $valueModulePageSlug['page_id'] }}" onchange="checkSubCheckbox({{ $valueModulePageSlug['page_id']}},{{ $valueModulePageSlug['parent_page_id'] }})" id="pages{{ $valueModulePageSlug['page_id'] }}" class="add_class_sub_{{ $valueModulePageSlug['parent_page_id'] }} kt-checkbox kt-checkbox--single kt-checkbox--solid"> {{ $valueModulePageSlug['page_slug'] }}
														<span></span>
													</label>
													@endif
													@endforeach
