		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('update-bank-details') }}" method="POST" style="margin-top: -20px;">
						...
						<div class="kt-portlet__body">
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										...
										@foreach($bankName as $bankNames)
											<option @if($editBankDetailsData->fk_bank_name == $bankNames->bank_name_id) selected @endif value="{{ $bankNames->bank_name_id }}">{{ $bankNames->bank_name }}</option>
										@endforeach
										</select>
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="bank_account_type" placeholder="Enter Bank Account Type" value="{{ $editBankDetailsData->bank_account_type }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="bank_branch" placeholder="Enter Bank Branch" value="{{ $editBankDetailsData->bank_branch }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="bank_account_number" placeholder="Enter Account Number" value="{{ $editBankDetailsData->bank_account_number }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="bank_ifsc_code" placeholder="Enter IFSC Code" value="{{ $editBankDetailsData->bank_ifsc_code }}">
						...
						<input type="hidden" name="editId" value="{{ $editBankDetailsData->bank_detail_id }}">
