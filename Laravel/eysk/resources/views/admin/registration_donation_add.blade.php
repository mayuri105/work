		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('save-registration-donation') }}" method="POST" style="margin-top: -5px;">
						...
						<div class="kt-portlet__body">
							<div class="kt-form__section kt-form__section--first">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="region_registration_amount" placeholder="ENTER REGION REGISTRATION AMOUNT" value="{{ old('region_registration_amount') }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="yuva_mandal_registration_amount" placeholder="ENTER YUVA MANDAL REGISTRATION AMOUNT" value="{{ old('yuva_mandal_registration_amount') }}">
