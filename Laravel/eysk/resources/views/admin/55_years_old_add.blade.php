...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
	...
	<div class="kt-container kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<!--begin::Portlet-->
		<form method="POST" action="{{ route('save-ysk-transfer-to-registration',$id) }}" enctype="multipart/form-data">
			...
			<div class="kt-portlet kt-portlet--tab">
				...
				<div class="main-padding">
						...
						<div class="form-group1 m-form__group1 row getYskId" style="display: none;">  
							...
							<div class="col-lg-9">
								<input type="text" class="form-control" aria-describedby="emailHelp" value="{{ old('ysk_id') }}" placeholder="Enter Ysk Id" id="ysk_id" name="ysk_id" onchange="getNewMemberYskId(this.value)">
						...
						<div class="form-group1 m-form__group1 row" id="nameAsPerYuvaSangh">  
							...
							<div class="col-lg-9">
								<input type="text" class="form-control {{-- addname --}}" value="{{ old('name_as_per_yuva_sangh_org') }}" aria-describedby="emailHelp" name="name_as_per_yuva_sangh_org" placeholder="Enter Name As Per YuvaSangh Field" onchange="writeSameName(this.value)">
						...
						<div class="form-group1 m-form__group1 row">  
							...
							<div class="col-lg-9" id="addsamajzone">
								<select class="form-control kt-select2" id="samaj_zone_name" name="fk_samaj_zone_id" onchange="getYuvaMandal(this.value);">
									<option value="" selected>Select SamajZone</option>    
						...
						<div class="form-group1 m-form__group1 row">  
							...
							<div class="col-lg-9 addyuvamandal">
								<select class="form-control kt-select2" id="yuva_mandal_name" name="fk_yuva_mandal_id">
					...
					<div class="form-group1 m-form__group1 row">  
						...
						<div class="col-lg-9">
							<textarea class="form-control addhomeaddress" id="exampleTextarea" name="home_address" rows="3" placeholder="Enter Home Address">{{ old('home_address') }}</textarea>
								...
								<div class="col-sm-12">
									<div id="abc" class="tabcontent">
										<div class="row"> 
											<div class="col-sm-12">
												...
												<input type="text" id="state_name" class="form-control" name="india_state" placeholder="Enter State" aria-describedby="emailHelp"> 
											...
											<div class="col-sm-12">
												...
												<div class="col-sm-12 adddistrict">
													<input type="text" id="district_name" class="form-control" name="fk_district_id" placeholder="Enter District" aria-describedby="emailHelp"> 
											...
											<div class="col-sm-12">
												...
												<div class="col-sm-12 addcity">
													<input type="text" id="city_name" class="form-control" name="fk_city_id" placeholder="Enter District" aria-describedby="emailHelp">
									...
									<div id="xyz" class="tabcontent">
										<div class="row check-box"> 
											<div class="col-sm-12">
												<label class="col-form-label">State</label>  
												<input type="text" class="form-control" name="overseas_state" placeholder="Enter State" aria-describedby="emailHelp">
											...
											<div class="col-sm-12">
												<label class="col-form-label">City</label>  
												<input type="text" class="form-control" name="overseas_city" placeholder="Enter City" aria-describedby="emailHelp">
					...
					<div class="form-group1 m-form__group1 row">  
						...
						<div class="col-lg-9">
							<input type="text" class="form-control addpincode" name="pincode" placeholder="Enter Pincode" aria-describedby="emailHelp">
					...
					<div class="form-group1 m-form__group1 row">  
						...
						<div class="col-lg-9">
							<input type="text" class="form-control addphonenumber" aria-describedby="emailHelp" name="phone_number_first" value="{{ old('phone_number_first') }}" placeholder="Enter Phone Number">
					...
					<div class="form-group1 m-form__group1 row">  
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" aria-describedby="emailHelp" name="phone_number_second" value="{{ old('phone_number_second') }}" placeholder="Enter Phone Number">
						</div>
					</div>
					...
					<input type="hidden" name="Page_id" id="page_id" value="{{ time() }}">		
					<div class="form-group1 m-form__group1 row">  
					...
					<div class="main-padding">
						...
						<div class="form-group1 m-form__group1 row">  
							...
							<div class="col-lg-9">
								<input type="text" class="form-control" id="ysk_member_bank_name" name="ysk_member_bank_name" value="{{ old('ysk_member_bank_name') }}" placeholder="Enter Ysk Member Bank Name" aria-describedby="emailHelp">
						...
						<div class="form-group1 m-form__group1 row">  
							...
							<div class="col-lg-9">
								<input type="text" class="form-control" id="branch_name" name="branch_name" value="{{ old('branch_name') }}" placeholder="Enter Branch Name" aria-describedby="emailHelp">
						...
						<div class="form-group1 m-form__group1 row">  
							...
							<div class="col-lg-9">
								<textarea class="form-control" id="narration" name="narration" placeholder="Enter Details" rows="4" cols="5">{{ old('narration') }}</textarea>
		...
		<div class="kt-title__head">
          ...
          <div class="main-padding">
          	<div class="form-group1 m-form__group1 row">  
          		...
          		<div class="col-lg-9">
          			<input type="text" class="form-control" id="first_nominee_family_id" name="first_nominee_family_id" value="{{ old('first_nominee_family_id') }}" placeholder="First Nominee Family Id" aria-describedby="emailHelp" onchange="nomineeCallApi1(this.value)">
          	...
          	<div class="form-group1 m-form__group1 row">  
          		...
          		<div class="col-lg-9">
          			<input type="text" class="form-control" id="first_nominee_name" name="first_nominee_name" placeholder="Enter First Nominee Name" aria-describedby="emailHelp" readonly style="background-color: #d3d3d3;">
          	...
          	<div class="form-group1 m-form__group1 row">  
          		...
          		<div class="col-lg-9">
          			<input type="text" class="form-control" name="first_nominee_relation" placeholder="First Nominee Relation" aria-describedby="emailHelp">
          	...
          	<div class="form-group1 m-form__group1 row">  
          		...
          		<div class="col-lg-9">
          			<input type="text" class="form-control" id="second_nominee_name" name="second_nominee_name" placeholder="Enter Second Nominee Name" aria-describedby="emailHelp" readonly style="background-color: #d3d3d3;">
          	...
          	<div class="form-group1 m-form__group1 row">  
          		...
          		<div class="col-lg-9">
          			<input type="text" class="form-control" name="second_nominee_relation" placeholder="Enter Second Nominee Relation" aria-describedby="emailHelp">
          ...
          <div class="main-padding main-padding1">
          	<div class="row">	
          		<div class="col-sm-3 col-md-3">
          			<label class="col-form-label">Name
          				<span class="text-danger">*</span>		
          			</label>
          			<input type="text" class="form-control" value="{{ $get55YearsPersonData['hidden_name_as_per_yuva_sangh_org'] }}" aria-describedby="emailHelp" name="old_member_name" placeholder="Enter Original Name" readonly>
          		</div>

          		<div class="col-sm-3 col-md-3">
          			<label class="col-form-label">YSK ID
          				<span class="text-danger">*</span>		
          			</label>
          			<input type="text" class="form-control" value="@if($get55YearsPersonData['ysk_id'] != ''){{ $get55YearsPersonData['ysk_id'] }} @else {{ $get55YearsPersonData['pre_ysk_id'] }} @endif" aria-describedby="emailHelp" name="old_member_ysk_id" placeholder="Enter Original Ysk Id" readonly>
          		</div>

          		<div class="col-sm-3 col-md-3">
          			<label class="col-form-label">Region
          				<span class="text-danger">*</span>		
          			</label>
          			<input type="text" class="form-control" value="{{ $get55YearsPersonData['region_name'] }}" aria-describedby="emailHelp" name="fk_old_member_region_id" placeholder="Enter Region Name" readonly>
          		</div>

          		<div class="col-sm-3 col-md-3">
          			<label class="col-form-label">Registration Fee
          				<span class="text-danger">*</span>		
          			</label>
          			<input type="text" class="form-control" value="{{ $get55YearsPersonData['registration_amount'] }}" aria-describedby="emailHelp" id="old_member_registration_fees" name="old_member_registration_fees" placeholder="Enter Original Registration Fees" readonly>
          		</div>
          		<input type="hidden" name="original_registration_id" value="{{ $get55YearsPersonData['registration_id'] }}">
          	</div>
          </div>
          ...
          <div class="main-padding main-padding1">
          	<div class="row">	
          		<div class="col-sm-3 col-md-3">
          			...
          			<input type="text" class="form-control" aria-describedby="emailHelp" id="new_member_name" name="new_member_name" value="{{ old('new_member_name') }}" readonly placeholder="Enter New Member Name" readonly>
          		</div>
          		...
          		<div class="col-sm-3 col-md-3">
          			...
          			<input type="text" class="form-control" aria-describedby="emailHelp" value="{{ old('new_member_ysk_id') }}" id="new_member_ysk_id" name="new_member_ysk_id" placeholder="Enter New Member Ysk Id" readonly>
          		</div>
          		...
          		<div class="col-sm-3 col-md-3">
          			...
          			<select class="form-control kt-select2" id="fk_new_member_region_id" name="fk_new_member_region_id" onchange="getSamajZone(this.value);">
          				<option value="" selected>Select Region</option>
          				@foreach($regionData as $valueRegionData)
          				<option value="{{ $valueRegionData->region_id }}">{{ strtoupper($valueRegionData->region_name) }}({{ $valueRegionData->region_code }})</option>
          				@endforeach 
          		...
          		<div class="col-sm-3 col-md-3">
          			...
          			<input type="text" class="form-control newMemberRegistartionFees" aria-describedby="emailHelp" name="new_member_registartion_fees" value="{{ old('new_member_registartion_fees') }}" placeholder="Enter New Member Registration Fees" readonly>
          		</div>


          		<div class="col-sm-6 col-md-6"></div>
          		<div class="col-sm-6 col-md-6 difference-mt" id="difference_mt">
          			<label class="col-form-label">Difference Amount
          				<span class="text-danger">*</span>		
          			</label>
          			<input type="text" class="form-control" aria-describedby="emailHelp" id="difference_amount" name="difference_amount" value="{{ old('difference_amount') }}" placeholder="Enter Difference Amount">
          		</div>
          	</div>
          </div>
          			...
          			<div class="kt-portlet__head-toolbar">
          				<div class="kt-portlet__head-wrapper">
          					<div class="kt-portlet__head-actions">
          						...
          						<a href="{{ route('55-years-old') }}" class="btn-cancel-registration">Cancel</a>
          					</div>
          				</div>
          			</div>
          		</div>
		    ...
		    for (var i = 0; i < filesLength; i++) {
		        ...
		        if (t != 'pdf') {
		        	fileReader.onload = (function(e) {
		        		var file = e.target;
		        		$("<span class=\"pip\">" +
		        			"<img class=\"imageThumb\" id=\"myAbbr\" src=\"" + e.target.result + "\" title=\"" + fileName + "\"/>" +
		        			"<br/><span class=\"remove\" onclick = \"function1()\">Remove image</span>" +
		        	...
		        	//alert(pageId);
		        	/*$.ajax({
		        		url: '{{ route('insert-image-during-preview') }}',
		        		type: 'POST',
		        		data: {Page_id:pageId,yskregistrationimage:fileName,_token:"{{ csrf_token() }}"},
		        	})*/
		        }
		        else{
		        	fileReader.onload = (function(e) {
			...
			$.ajax({
				...
				success: function(response){
					...
					if(obj.success == 1){
						...
						//$("#councilname").html(obj.html_data_concil);
...
<script>
	...
	function callDataByMemberId(memberId) {
		 ...
		 var originalRegistrationAmount = $('#old_member_registration_fees').val();
		 //$('.loaderOne').show();
		$.ajax({
			type:"POST",
			...
			success: function(response){
				...
				if(obj.success == 1){
					...
					if (obj.BirthDate != "01-01-1970") {
						...
						$(".newMemberRegistartionFees").val(obj.html_registration_fees);
						$(".newMemberRegistartionFees").css('background', '#d3d3d3');
					}
					else{
						...
						document.getElementsByClassName("newMemberRegistartionFees").placeholder;
						$('.newMemberRegistartionFees').val('');
					}
					...
					$('#fk_new_member_region_id').val(obj.RegionId);
					$('#fk_new_member_region_id').select2().trigger('change');
					...
					if (Number(obj.html_registration_fees) > Number(originalRegistrationAmount)) {
						var differenceAmount = Number(obj.html_registration_fees) - Number(originalRegistrationAmount);
						alert(Number(originalRegistrationAmount));
						$('#difference_amount').val(differenceAmount);
						$('#difference_amount').css('background', '#d3d3d3');
					}					
					else if(Number(obj.html_registration_fees) <= Number(originalRegistrationAmount)){
						$('#difference_mt').hide();
					}
				}
			}
	...
	function getYskId(value) {
		var x = new Date('12-31-2019');
		var y = new Date(value.replace( /(\d{2})-(\d{2})-(\d{4})/, "$2/$1/$3"));
		if (y <= x) {
			$('.getYskId').show();
			$('#new_member_ysk_id').show();
		}
		else{
			$('.getYskId').hide();
			$('#new_member_ysk_id').hide();
		}
...
/*function function1() {
	var pageId = $('#page_id').val();
	var imageName = document.getElementById("myAbbr").title;
	$.ajax({
		url: '{{ route('delete-temp-image') }}',
		type: 'POST',
		data: {Page_id:pageId,yskregistrationimage:imageName,_token:"{{ csrf_token() }}"},
	})	
}*/
</script>
<script>
	function writeSameName(value) {
		$('#new_member_name').val(value);
	}

	function getNewMemberYskId(value) {
		$('#new_member_ysk_id').val(value);
	}
	$('#fk_new_member_region_id').select2();
	$('#division_name').select2();
