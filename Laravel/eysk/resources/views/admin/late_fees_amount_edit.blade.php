		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('update-late-fees-amount') }}" method="POST" style="margin-top: -5px;">
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control start_date" name="start_date" value="{{ date("d-m-Y",strtotime($editLateFeesAmount->start_date)) }}" placeholder="ENTER START DATE">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control end_date" name="end_date" value="@if($editLateFeesAmount->end_date !='0000-00-00'){{ date("d-m-Y",strtotime($editLateFeesAmount->end_date)) }} @endif" placeholder="ENTER END DATE">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="late_fees_days" placeholder="ENTER LATE FEES DAYS" value="{{ $editLateFeesAmount['late_fees_days'] }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="late_fees_charges" placeholder="ENTER LATE FEES CHARGES" value="{{ $editLateFeesAmount['late_fees_charges'] }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="grace_days" placeholder="ENTER GRACE DAYS" value="{{ $editLateFeesAmount['grace_days'] }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="grace_period_charges" placeholder="ENTER GRACE PERIOD CHARGES" value="{{ $editLateFeesAmount['grace_period_charges'] }}">
						...
						<input type="hidden" name="editId" value="{{ $editLateFeesAmount['late_fees_amount_id'] }}">
