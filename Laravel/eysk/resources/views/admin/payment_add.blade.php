											...
											<div class="Half-section-details">
												...
												<div class="form-group1 m-form__group1 row">
													...
													<div class="col-lg-2" style="margin-left: -150px;">
														...
														<input type="text" id="today_date" name="date" class="form-control" placeholder="ENTER DATE" value="{{ old('date') }}" >
													...
													<div class="col-lg-2">
														...
														<input type="text" id="payment_no" name="payment_no" class="form-control" placeholder="ENTER PAYMENT NUMBER" value="{{ $payment_no }}" readonly="">
...
{{--										@endforeach--}}
										...
										@if ($errors->has('fk_ledger_account_id_main'))<span style="color: red;">{{ $errors->first('fk_ledger_account_id_main') }}</span>@endif
									</div>
															...
															<div class="col-lg-2">
																...
																<input type="text" class="form-control amount_main"  id="amount_main" name="amount_main" placeholder="ENTER AMOUNT" value="{{ old('amount_main') }}">
										...
										@endforeach
															...
															<div class="col-lg-2 padding-mt">
																<div class="row">
																	<div class="col-sm-3" style="margin-top: 10px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type[1][]" value="Debit"  id="Debit" disabled> Debit
																				<span class="tablinks"></span>
																			</label>
																		</div>
																	</div>
																	<div class="col-sm-3" style="margin-top: 10px;margin-left: 20px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type[1][]" value="Credit" checked  id="Credit"> Credit
																				<span class="tablinks" ></span>
																			</label>
																		</div>
																	</div>
															...
															<div class="col-lg-2 padding-mt">
																<label>Amount<span class="text-danger">*</span></label>
																<input type="text" class="form-control amount"  id="amount" name="amount[]" placeholder="ENTER AMOUNT" value="{{ old('amount.0') }}" required>
