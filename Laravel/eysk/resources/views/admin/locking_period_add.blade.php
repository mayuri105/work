		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('save-locking-period') }}" method="POST" style="margin-top: -5px;">
						...
						<div class="kt-portlet__body">
							<div class="kt-form__section kt-form__section--first">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="locking_days" placeholder="ENTER LOCKING DAYS" value="{{ old('locking_days') }}">
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="disease_days" placeholder="ENTER DISEASE DAYS" value="{{ old('disease_days') }}">
