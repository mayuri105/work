			...
			<div class="col-lg-12">
				...
				<div class="kt-portlet">
					...
					<div class="mtt-body">
						...
						<form action="{{ route('update-receipt') }}" enctype="multipart/form-data" method="POST">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div id="London" class="w3-container city">
											...
											<div class="Half-section-details">
												...
												<div class="form-group1 m-form__group1 row">
													...
													<div class="col-lg-2" style="margin-left: -150px;">
														...
														<input type="text" id="date" name="date" class="form-control" placeholder="ENTER DATE" value="{{ date('d-m-Y',strtotime($editReceiptData['date'])) }}">
												...
												<div class="col-lg-5">
													...
													<div class="col-lg-2">
														...
														<input type="text" id="receipt_voucher_no" name="receipt_voucher_no" class="form-control" placeholder="ENTER RECEIPT NUMBER" value="{{ $editReceiptData['receipt_voucher_no'] }}" readonly="">
													...
													<div class="registration-list-modal" style="width: 100%;">
														<div class="row">
															<div class="col-lg-4">
																...
																<div>
																	<select class="form-control" name="fk_ledger_account_id_main" id="fk_ledger_account_id">
																		...
																		<option  @if($editReceiptData->fk_ledger_account_id_main == $ledgeraccountss->ledger_account_id) selected @endif value="{{ $ledgeraccountss->ledger_account_id }}">{{ $ledgeraccountss->legder_name }}</option>
																		@endforeach
																	</select>
															...
															<div class="col-lg-2">
																<div class="row">
																	<div class="col-sm-3" style="margin-top: 10px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type_main" @if($editReceiptData->transaction_type_main == 'Debit') checked @endif value="Debit" checked  class="transaction_type_main"> Debit
																	...
																	<div class="col-sm-3" style="margin-top: 10px;margin-left: 20px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type_main" @if($editReceiptData->transaction_type_main == 'Credit') checked @endif value="Credit" class="transaction_type_main" disabled> Credit
																				<span class="tablinks" ></span>
																			</label>
																		</div>
																	</div>
															...
															<div class="col-lg-2">
																...
																<input type="text" class="form-control amount_main"  id="amount_main" name="amount_main" placeholder="ENTER AMOUNT" value="{{ $editReceiptData['amount_main'] }}" >
									     ...
									     <div class="form-group1 m-form__group1 row details">
									   	<?php $i= 1;?>
									     @foreach($receiptdetail as $receiptdetails)
									     	...
									     	<div class="registration-list-modal" style="width: 100%;padding-left: 10px;">
									     		...
									     		<div class="row">
									     			...
									     			<div class="col-lg-4 padding-mt">
									     				<label>Ledger Account<span class="text-danger">*</span></label>
									     				<div>
									     					<select class="form-control" name="fk_ledger_account_id[]" id="fk_ledger_account_id<?=$i?>" required>
									     						<option value="" selected="selected">SELECT LEDGER ACCOUNT</option>
									     						@foreach($ledgeraccounts2 as $ledgeraccounts2s)
									     						<option value="{{ $ledgeraccounts2s->ledger_account_id }}" @if($receiptdetails->fk_ledger_account_id == $ledgeraccounts2s->ledger_account_id) selected @endif>{{ $ledgeraccounts2s->legder_name }}</option>
									     						@endforeach
									     					</select>
									     			...
									     			<div class="col-lg-2 padding-mt">
									     				<div class="row">
									     					<div class="col-sm-3" style="margin-top: 10px;">
									     						...
									     						<div class="kt-radio-inline redio-mt">
									     							<label class="kt-radio">
									     								<input type="radio" name="transaction_type[{{$i}}][]" value="Debit" @if($receiptdetails->transaction_type == 'Debit') checked @endif class="transaction_type"  id="Debit" disabled> Debit
									     								<span class="tablinks"></span>
									     							</label>
									     						</div>
									     					</div>
									     					<div class="col-sm-3" style="margin-top: 10px;margin-left: 20px;">
									     						...
									     						<div class="kt-radio-inline redio-mt">
									     							<label class="kt-radio">
									     								<input type="radio" name="transaction_type[{{$i}}][]" value="Credit" @if($receiptdetails->transaction_type == 'Credit') checked @endif class="transaction_type" checked  id="Credit"> Credit
									     								<span class="tablinks" ></span>
									     							</label>
									     						</div>
									     					</div>
									     			...
									     			<div class="col-lg-2 padding-mt">
									     				<label>Amount<span class="text-danger">*</span></label>
									     				<input type="text" class="form-control amount"  id="amount" name="amount[]" placeholder="ENTER AMOUNT" value="{{$receiptdetails->amount}}" required>
										...
										@endforeach
									     	...
									     	<div class="col-lg-8">
                                                ...
                                                <textarea class="form-control" id="narration_main" name="narration_main" placeholder="ENTER NARRATION" value="{{ old('narration_main') }}" maxlength="150">{{ $editReceiptData['narration_main'] }}</textarea>
{{--																	<input type="text" class="form-control" aria-describedby="emailHelp" id="narration" name="narration_main" placeholder="ENTER NARRATION" value="{{ $editReceiptData['narration_main'] }}">--}}
										...
										<input type="hidden" name="editId" value="{{ $editReceiptData['receipt_id'] }}">									<input type="submit" name="submit" value="  Edit  " class="btn btn-brand btn-warning btn-elevate btn-icon-sm">
