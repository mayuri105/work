		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-9 order-lg-1 order-xl-1">
				<div class="kt-portlet kt-portlet--mobile">
					...
					<!--begin::Form-->
					<form class="kt-form" action="{{ route('save-samaj-zone') }}" method="POST" style="margin-top: -5px;">
						...
						<div class="kt-portlet__body">
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<select class="form-control m-input" name="region_name" id="region_name">
											...
											<option @if(old('region_name')== $valueRegionsData->region_id) selected @endif value="{{ $valueRegionsData->region_id }}">{{ $valueRegionsData->region_name }}({{ $valueRegionsData->region_code }})</option>
											@endforeach
										</select>
								...
								<div class="form-group row">
									...
									<div class="col-xl-10 col-lg-10 col-sm-12 col-md-12">
										<input type="text" class="form-control" name="samaj_zone_name" placeholder="ENTER SAMAJ ZONE NAME" value="{{ old('samaj_zone_name') }}" style="text-transform: uppercase;">
