			...
			<div class="col-lg-12">
				...
				<div class="kt-portlet">
					...
					<div class="mtt-body">
						...
						<form action="{{ route('update-payment') }}" enctype="multipart/form-data" method="POST">
											...
											<div class="Half-section-details">
												...
												<div class="form-group1 m-form__group1 row">
													...
													<div class="col-lg-2" style="margin-left: -150px;">
														...
														<input type="text" id="date" name="date" class="form-control" placeholder="ENTER DATE" value="{{ date('d-m-Y',strtotime($editPaymentData['date'])) }}">
													...
													<label class="col-lg-2 col-form-label" style="padding-left: 70px;">Payment Number<span class="text-danger">*</span></label>

													<div class="col-lg-2">

														<input type="text" id="payment_no" name="payment_no" class="form-control" placeholder="ENTER PAYMENT NUMBER" value="{{ $editPaymentData['payment_no'] }}" readonly="">
															...
															<div class="col-lg-4">
																...
																<div>
																	<select class="form-control" name="fk_ledger_account_id_main" id="fk_ledger_account_id">
																		...
																		<option  @if($editPaymentData->fk_ledger_account_id_main == $ledgeraccountss->ledger_account_id && $editPaymentData->type_account_main == '1') selected @endif value="{{ $ledgeraccountss->ledger_account_id }},1">{{ $ledgeraccountss->legder_name }}</option>
																		@endforeach


										@foreach($registrationaccounts as $registrationaccountss)
											<option  @if($editPaymentData->fk_ledger_account_id_main == $registrationaccountss->registration_id && $editPaymentData->type_account_main == '2') selected @endif value="{{ $registrationaccountss->registration_id }},2">{{ $registrationaccountss->name_as_per_yuva_sangh_org }}</option>
										@endforeach
															...
															<div class="col-lg-2">
																<div class="row">
																	<div class="col-sm-3" style="margin-top: 10px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type_main" @if($editPaymentData->transaction_type_main == 'Debit') checked @endif value="Debit" checked> Debit
																	...
																	<div class="col-sm-3" style="margin-top: 10px;margin-left: 20px;">
																		...
																		<div class="kt-radio-inline redio-mt">
																			<label class="kt-radio">
																				<input type="radio" name="transaction_type_main" @if($editPaymentData->transaction_type_main == 'Credit') checked @endif value="Credit" disabled> Credit
																				<span class="tablinks" ></span>
																			</label>
																		</div>
																	</div>
															...
															<div class="col-lg-2">
																<label>Amount</label>
																<input type="text" class="form-control"  id="amount" name="amount_main" placeholder="ENTER AMOUNT" value="{{ $editPaymentData['amount_main'] }}" >
...
{{--																	<input type="text" class="form-control" aria-describedby="emailHelp" id="narration" name="narration_main" placeholder="ENTER NARRATION" value="{{ $editPaymentData['narration_main'] }}">--}}
									     			...
									     			<div class="col-lg-4 padding-mt">
									     				...
									     				<div>
									     					<select class="form-control" name="fk_ledger_account_id[]" id="fk_ledger_account_id<?=$i?>" >
									     						...
									     						<option value="{{ $ledgeraccounts2s->ledger_account_id }},1" @if($paymentdetails->fk_ledger_account_id == $ledgeraccounts2s->ledger_account_id && $paymentdetails->type_account == '1') selected @endif>{{ $ledgeraccounts2s->legder_name }}</option>
									     @endforeach

									     @foreach($registrationaccounts as $registrationaccountss)
											<option value="{{ $registrationaccountss->registration_id }},2" @if($paymentdetails->fk_ledger_account_id == $registrationaccountss->registration_id && $paymentdetails->type_account == '2') selected @endif>{{ $registrationaccountss->name_as_per_yuva_sangh_org }}</option>
										@endforeach
									     			...
									     			<div class="col-lg-2 padding-mt">
									     				<div class="row">
									     					<div class="col-sm-3" style="margin-top: 10px;">
									     						...
									     						<div class="kt-radio-inline redio-mt">
									     							<label class="kt-radio">
									     								<input type="radio" name="transaction_type[{{$i}}][]" value="Debit" @if($paymentdetails->transaction_type == 'Debit') checked @endif disabled> Debit
									     								<span class="tablinks"></span>
									     							</label>
									     						</div>
									     					</div>
									     					<div class="col-sm-3" style="margin-top: 10px;margin-left: 20px;">
									     						...
									     						<div class="kt-radio-inline redio-mt">
									     							<label class="kt-radio">
									     								<input type="radio" name="transaction_type[{{$i}}][]" value="Credit" @if($paymentdetails->transaction_type == 'Credit') checked @endif> Credit
									     								<span class="tablinks" ></span>
									     							</label>
									     						</div>
									     					</div>
									     			...
									     			<div class="col-lg-2 padding-mt">
									     				<label>Amount</label>
									     				<input type="text" class="form-control"  id="amount" name="amount[]" placeholder="ENTER AMOUNT" value="{{$paymentdetails->amount}}">
									     				@if ($errors->has('amount'))
									     				<span style="color: red;">
									     					{{ $errors->first('amount') }}</span>@endif
									     			</div>
...
{{--									     					<label>Narration</label>--}}
{{--									     					<input type="text" class="form-control" aria-describedby="emailHelp" id="narration" name="narration[]" placeholder="ENTER NARRATION" value="{{$paymentdetails->narration}}">--}}
{{--									     					@if ($errors->has('narration'))--}}
{{--									     					<span style="color: red;">--}}
{{--									     						{{ $errors->first('narration') }}--}}
{{--									     					</span>--}}
...
{{--									     				</div>--}}
										...
										@endforeach
                                                ...
                                                <div class="form-group1 m-form__group1 row">
                                                    <div class="col-lg-8">
                                                        ...
                                                        <textarea class="form-control" id="narration_main" name="narration_main" placeholder="ENTER NARRATION" value="{{ old('narration_main') }}" maxlength="150">{{ $editPaymentData['narration_main'] }}</textarea>
										...
										<input type="hidden" name="editId" value="{{ $editPaymentData['payment_id'] }}">									<input type="submit" name="submit" value="  Edit  " class="btn btn-brand btn-warning btn-elevate btn-icon-sm">

																			<a href="{{ route('payment') }}" class="btn-cancel-registration">Cancel</a>
