							...
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions main-back">
    									<a href="{{ route('registration') }}" class="btn btn-clean btn-icon-sm back-tt">
					...
					@endif		 --}}
							...
							<div class="col-sm-3 col-md-3 view-group">
								<div class="view-details-mtt">
									...
									@if($detailsRegistration['password'] != '')
									<span class="view-value-text">{{ $detailsRegistration['password'] }}</span>
									@else
									<span class="view-value-text">-</span>
									@endif
								</div>
