...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
	...
	<div class="kt-container kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<!--begin::Portlet-->
		<form action="{{ route('save-ach') }}" method="POST"> 
			...
			<div class="kt-portlet kt-portlet--tab">
				...
				<div class="main-padding">
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<select class="form-control kt-select2" id="fk_ysk_id" name="fk_ysk_id" onchange="getDataByYskId(this.value)" style="width: 100%;">
								<option value="" selected>SELECT YSK</option>
								@foreach($yskMember as $yskMembers)
									@if($yskMembers->ysk_id == '')
										<option value="{{ $yskMembers->pre_ysk_id }}">{{ $yskMembers->name_as_per_yuva_sangh_org }}({{ $yskMembers->pre_ysk_id }})</option>
									@else
										<option value="{{ $yskMembers->ysk_id }}">{{ $yskMembers->name_as_per_yuva_sangh_org }}({{ $yskMembers->ysk_id }})</option>
									@endif
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<select class="form-control kt-select2" id="fk_region_id" name="fk_region_id" style="width: 100%;">
								...
								<option value="{{ $regionNames->region_id }}">{{ $regionNames->region_name }}</option>
								@endforeach
							</select>
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<select class="form-control kt-select2" id="fk_yuva_mandal" name="yuva_mandal_number_id" style="width: 100%;">
								...
								@foreach($yuvaMandal as $yuvaMandals)
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<input type="text" id="city_name" name="city_name" placeholder="Enter City" class="form-control" aria-describedby="emailHelp" value="{{ old('city_name') }}" style="text-transform: uppercase;">
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<input type="text" id="name_as_per_yuva_sangh_org" name="name_as_per_yuva_sangh_org" class="form-control" placeholder="Enter Name As Per Yuva Sangh Org" aria-describedby="emailHelp" value="{{ old('name_as_per_yuva_sangh_org') }}" style="text-transform: uppercase;">
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" placeholder="ENTER PHONE NUMBER" id="phone_number" name="phone_number" aria-describedby="emailHelp" value="{{ old('phone_number') }}">
					...
					<div class="form-group1 m-form__group1 row">	
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" id="apply_date" placeholder="ENTER APPLY DATE" name="apply_date" aria-describedby="emailHelp" value="{{ old('apply_date') }}">
						...
						<div class="form-group1 m-form__group1 row">	
							...
							<div class="form-group1 m-form__group1 row">	
								...
								<div class="form-group1 m-form__group1 row">	
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="ENTER ACH LIMIT" name="ach_limit" aria-describedby="emailHelp" value="{{ old('ach_limit') }}">
...
<script>
	...
	function getDataByYskId(value) {
		$.ajax({
			url: '{{ route('data-by-ysk-id') }}',
			type: 'POST',
			data: {fk_ysk_id:value,_token:"{{ csrf_token() }}"},
			success:function (response) {
				var obj = JSON.parse(response);
				if (obj.success == '1') {
					$('#fk_region_id').val(obj.regionId);
					$('#fk_region_id').select2().trigger('change');
					$('#fk_yuva_mandal').val(obj.yuva_mandal_id);
					$('#fk_yuva_mandal').select2().trigger('change');
					$('#city_name').val(obj.city);
					$('#email').val(obj.email);
					$('#name_as_per_yuva_sangh_org').val(obj.nameAsPerYskOrg);
