	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
        ...
        <div class="kt-portlet kt-portlet--tab">
			...
			<div class="main-padding ceparetar">
           	...
           	<span class="view-value-text">Axis Bank</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text">Debit</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text">10-08-2019</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text"><i class="la la-inr"></i>12000</span>
           	</div>
           	</div>

           	<div class="col-sm-3 col-md-3 view-group">
           	<div class="view-details-mtt">
           	<span class="view-title-kt">Expense Type</span>
           	<span class="view-value-text">Decrease</span>
           	</div>
           	</div>

           	<div class="col-sm-3 col-md-3 view-group">
           	<div class="view-details-mtt">
           	<span class="view-title-kt">Type</span>
           	<span class="view-value-text">Registration Repayment</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text">yuvasangh@121</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text">Sometimes the word charge is used in place of debit.</span>
           	</div>
           	</div>
