					...
					<div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- "  >
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="suspense-account.php" class="kt-menu__link"><span class="kt-menu__link-text">Suspense Account</span></a></li>
					...
					<div class="main-padding ceparetar">
		           	  <div class="row"> 
		           	     <div class="col-sm-3 col-md-3 view-group">
		                    	...
		                    	<span class="view-value-text">176</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">Bank Total</span>
		                    	<span class="view-value-text">Rs. 3,15,500.00</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">Sbi Rs.</span>
		                    	<span class="view-value-text">2,00,000.00</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">HDFC Rs.</span>
		                    	<span class="view-value-text">1,15,500.00</span>
		           	        </div>
		             	</div>
		             	 <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
      ...
      <div class="kt-portlet__head-toolbar">
         <div class="kt-portlet__head-wrapper">
            <div class="kt-portlet__head-actions">
               <a href="add-suspense-account.php" class="btn btn-brand btn-warning btn-elevate btn-icon-sm">
		 ...
		 <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="today_datatable" role="grid" aria-describedby="kt_table_1_info" style="width: 1147px;">
			<thead>
				 <tr role="row">
                        ...
                        <!-- <th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 64.25px;" aria-label="Country: activate to sort column ascending">Detail</th> -->
			...
			<tbody>
				<tr role="row" class="odd">
                        ...
                        <td>Debit</td>
                        <td>10-08-2019</td>
                        <td><i class="la la-inr"></i>12000</td>
                      
                        <td nowrap="">
                          <a href="view-suspense-account.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
                           </a>
                            <a href="edit-suspense-account.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="Edit">
                           <i class="la la-edit"></i>
                           </a>
                           <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="Delete">
                           <i class="la la-trash"></i>
                           </a>
                           <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" data-toggle="modal" data-target="#kt_modal_1" title="Genrate YSK ID"> <i class="la la-external-link"></i></a>
                        </td>
                     </tr>
                     <tr role="row" class="odd">
                        <th style="width: 5%;" class="text-center sorting_disabled" rowspan="1" colspan="1"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid">
...
<!-- content end -->
	<!--begin::Modal-->
                ...
                <h5 class="modal-title" id="exampleModalLabel">Assign Suspense Account</h5>
            	...
            	<div class="modal-body">
               	...
               	<div class="row">	
					...
					<select class="form-control kt-select2" id="kt_select26_26" name="param" style="width: 100%;">
                    <option value="AK">Select a Type</option>
                    <option value="AK">Registration Repayment</option>
                    <option value="HI">Registration Chequebounce</option>
                    </select>
					</div>

					<div class="col-sm-4 padding-mt">	
    				<label>YSK Id<span class="text-danger">*</span></label>
    				<div>
    				<select class="form-control kt-select2" id="kt_select24_24" name="param"  style="width: 100%">
                    <option value="AK">Select a YSK Id</option>
                    <option value="AK">yuvasangh@121</option>
                    <option value="HI">yuvasangh@122</option>
                    </select>	
    				</div>			
    				</div>
					...
					<div class="col-sm-1 padding-kt" style="margin-top: 50px;">
			       	<a href="#" class="nominee-details-add"><i class="la la-plus"></i></a>
			        </div>

			         <div class="col-sm-4 padding-mt">	
					<label>Type
					<span class="text-danger">*</span></label>
					<select class="form-control kt-select2" id="kt_select27_27" name="param" style="width: 100%;">
                    <option value="AK">Select a Type</option>
                    <option value="AK">Registration Repayment</option>
                    <option value="HI">Registration Chequebounce</option>
                    </select>
    				...
    				<label>YSK Id<span class="text-danger">*</span></label>
    				<div>
    				<select class="form-control kt-select2" id="kt_select2_2" name="param"  style="width: 100%">
                    <option value="AK">Select a YSK Id</option>
                    <option value="AK">yuvasangh@121</option>
                    <option value="HI">yuvasangh@122</option>
                    </select>	
					...
					<div class="col-sm-1 padding-kt" style="margin-top: 50px;">
			       	<a href="#" class="nominee-details-add"><i class="la la-minus"></i></a>
			        </div>
               	</div>
