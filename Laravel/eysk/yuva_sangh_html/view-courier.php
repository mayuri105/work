	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
						...
						<div class="kt-portlet__head-toolbar">
							<div class="kt-portlet__head-wrapper">
								<div class="kt-portlet__head-actions main-back">
									<a href="courier.php" class="btn btn-clean btn-icon-sm back-tt">
        ...
        <div class="kt-portlet kt-portlet--tab">
			...
			<div class="main-padding ceparetar">
           	...
           	<span class="view-title-kt">YSK MEMBER</span>
           	<span class="view-value-text">yuvasangh121</span>
           	</div>
           	</div>
           	...
           	<div class="col-sm-3 col-md-3 view-group">
           	<div class="view-details-mtt">
           	<span class="view-title-kt">Courier Company</span>
           	<span class="view-value-text">Aramex India Pvt Ltd.</span>
           	</div>
           	</div>
           	...
           	<span class="view-value-text">Received</span>
           	</div>
           	</div>
