...
<body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading"  >
	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
					...
					<div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- "  >
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="repayment.php" class="kt-menu__link"><span class="kt-menu__link-text">Repayment</span></a></li>
					...
					<div class="main-padding ceparetar">
		           	  <div class="row"> 
		           	     <div class="col-sm-4 col-md-4 view-group">
		                    	...
		                    	<span class="view-value-text">3,40,000,000 / 38,201</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-4 col-md-4 view-group">
		           	         <div class="view-details-mtt">
       ...
       <!-- my section new add end-->   
                ...
                <option value="AK">Select a Region</option>
				...
				<span>Total Amount : <i class="la la-rupee"></i> 10,20,000</span>
				</div>
				</div>

				<div class="col-sm-2 col-md-2">
				<div class="repayment-amount-mtt">
				<span>Pending Amount : <i class="la la-rupee"></i> 10,30,900</span>
				</div>
				</div>	

                <div class="col-sm-2 col-md-2">
				<div class="repayment-amount-mtt">
				<span>Paid Amount : <i class="la la-rupee"></i> 10,20,900</span>
				</div>
				</div>
   ...
   <div class="kt-portlet__body">
               ...
               <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1147px;">
                  ...
                  <tbody>
                     <tr role="row" class="odd">
                        ...
                        <td><span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill">Active</span></td>
                        
                        <td nowrap="">
                          <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
                           </a>
                           <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" data-toggle="modal" data-target="#kt_modal_4" title="Payment">
                     ...
                     <tr role="row" class="odd">
                        ...
                        <td>lorem ipsum</td>
                       	<td>1234567890</td>
                       	<td>
                        <span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill" style="background-color: #FFA500;">Pending</span></td>
                    	</td>
                        <td nowrap="">
                          <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
      ...
      <div class="row">
               <div class="col-sm-12 col-md-5">
                  <div class="dataTables_info" id="kt_table_1_info" role="status" aria-live="polite">Showing 2 to 2 of 2 entries</div>
               </div>
