					...
					<div class="main-padding ceparetar">
		           	  <div class="row"> 
		           	     <div class="col-sm-3 col-md-3 view-group">
		                    	...
		                    	<span class="view-title-kt">55/60 year Pending entries</span>
		             	  ...
		             	  <div class="col-sm-3 col-md-3 view-group">
		                    	...
		                    	<span class="view-value-text">211</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
                  ...
                  <tbody>
                     <tr role="row" class="odd">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                       	<a class="dropdown-item" href="#">YSK Mitra</a>
                        <a class="dropdown-item" href="add-55-year-old.php">Transfer</a>
                        ...
                        <td nowrap="">
                           <a href="view-55-year-old.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
                           </a>
                        </td>
                     </tr>
