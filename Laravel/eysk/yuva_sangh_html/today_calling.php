					...
					<div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- "  >
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="today_calling.php" class="kt-menu__link"><span class="kt-menu__link-text">Today's Calling</span></a></li>
							</ul>
						</div>
					</div>
					<!-- end: Header Menu -->   
						...
						<div class="kt-portlet">
							...
							<div class="kt-portlet__body">
								<ul class="nav nav-pills nav-fill" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#kt_tabs_5_1">Courier</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#kt_tabs_5_2">ACH</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#kt_tabs_5_3">Pending Repayment</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#kt_tabs_5_4">Pending Registration Form</a>
									</li>
								</ul>                    
								<div class="tab-content">
									<div class="tab-pane active" id="kt_tabs_5_1" role="tabpanel">
										<div class="table-responsive">
											<table id="today_datatable" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
														<td>YSK1234567890</td>
														<td>lorem ipsum</td>
														<td>ACH Form</td>
														<td>25-08-2019</td>
														<td>Aramex India Pvt Ltd.</td>
														<td>AIPL123456</td>
														<td><span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill">Received</span></td>
														<td></td>
													</tr>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
														...
														<td>ACH Form</td>
														<td>25-08-2019</td>
														<td>FedEx Express TSCS India Pvt Ltd.</td>
														<td>FedEx00001</td>
														<td><span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill">Send</span></td>
														<td></td>
													</tr>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
											...
											<table id="today_datatable1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td>25-08-2019</td>
														<td>lorem ipsum</td>
														<td><span class="kt-badge  kt-badge--brand kt-badge--inline kt-badge--pill">Not Receive</span></td>
														<td></td>
													</tr>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
											...
											<table id="today_datatable2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td>YSK1234567890</td>
														<td>lorem ipsum</td>
														<td><i class="la la-inr"></i>10000</td>
														<td>lorem ipsum</td>
														<td>1997</td>
											...
											<table id="today_datatable2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
														<td>lorem ipsum</td>
													    <td><span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill">Checkbounce</span></td>
														<td>lorem ipsum</td>
														<td>22-08-2019</td>
														<td></td>
													</tr>
													<tr>
														<td class="text-center"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="sub_check_all[]" value="{{ $regionDatas->region_id }}" class="sub_check_all" id="pages" style="width: 16px;height: 16px;"><span></span></label></td>
														<td>lorem ipsum</td>
														<td><span class="kt-badge  kt-badge--brand kt-badge--inline kt-badge--pill">Payment Not Receive</span></td>
														<td>lorem ipsum</td>
														<td>22-08-2019</td>
														<td></td>
													</tr>
