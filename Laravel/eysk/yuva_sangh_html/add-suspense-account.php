	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
						...
						<div class="kt-portlet__head-toolbar">
							<div class="kt-portlet__head-wrapper">
								<div class="kt-portlet__head-actions main-back">
									<a href="suspense-account.php" class="btn btn-clean btn-icon-sm back-tt">
        ...
        <div class="kt-portlet kt-portlet--tab">
            ...
            <span class="text-danger">*</span></label>	
             <div class="col-lg-9">
          	    <select class="form-control kt-select2" id="kt_select23_21" name="param">
                        <option value="AK">Select a Bank</option>
                        <option value="AK">Axis Bank</option>
                        <option value="HI">Bank of India</option>
                        <option value="CA">ICICI Bank</option>
                        <option value="NV">Kotak Bank</option>
                </select>
        	</div>
            </div>	
            ...
            <div class="col-lg-9">
          	    <div class="kt-radio-inline redio-mt">
					<label class="kt-radio">
						<input type="radio" name="radio2" checked="checked"> Debit
						<span class="tablinks" onclick="openCity(event, 'London')"></span>
					</label>
					<label class="kt-radio">
						<input type="radio" name="radio2"> Credit
			   ...
			   <div class="col-sm-12">
				  <div id="London" class="tabcontent tabs-r-active">
						...
						<label>Expense Type
						<span class="text-danger">*</span></label>
						<select class="form-control kt-select2" id="kt_select25_25" name="param" style="width: 100%;">
                        <option value="AK">Select a Expense</option>
                        <option value="AK">Decrease</option>
                        <option value="HI">Increase</option>
                        </select>
						</div>
