...
<body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading"  >
	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
		...
		<div class="kt-portlet">
            <div class="kt-portlet__head devangat-info">
            ...
            <div class="col-lg-9">
          	<input type="text" class="form-control" id="kt_datetimepicker_2" readonly="" placeholder="Select date &amp; time">
        	</div>
            </div>

            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Death Date</label>	
            <div class="col-lg-9">
          	<input type="text" class="form-control" id="kt_datetimepicker_2" readonly="" placeholder="Select date &amp; time">
        	</div>
            </div>
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Informer Name</label>	
            <div class="col-lg-9">
          	<input type="name" class="form-control" aria-describedby="emailHelp">
        	</div>
            </div>
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Death Type</label>	
            <div class="col-lg-9">
          	<input type="name" class="form-control" aria-describedby="emailHelp">
        	</div>
            </div>
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Death Reason</label>	
            <div class="col-lg-9">
          	<input type="name" class="form-control" aria-describedby="emailHelp">
        	</div>
            </div>
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Death Certificate Number</label>	
            <div class="col-lg-9">
          	<input type="name" class="form-control" aria-describedby="emailHelp">
        	</div>
            </div>
