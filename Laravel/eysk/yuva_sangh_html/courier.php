					...
					<div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- "  >
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="courier.php" class="kt-menu__link"><span class="kt-menu__link-text">Courier</span></a></li>
					...
					<div class="main-padding ceparetar">
		           	  <div class="row"> 
		           	     <div class="col-sm-3 col-md-3 view-group">
		                    	...
		                    	<span class="view-title-kt">Courier Dispatch</span>
		                    	<span class="view-value-text">10</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">Courier Received</span>
		                    	<span class="view-value-text">4</span>
		           	        </div>
		             	</div>
		             	  <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">Courier undelivered</span>
		             	  ...
		             	  <div class="col-sm-3 col-md-3 view-group">
		                    	...
		                    	<span class="view-value-text">1</span>
		           	        </div>
		             	</div>
		             	 <div class="col-sm-3 col-md-3 view-group">
		           	         <div class="view-details-mtt">
		                    	<span class="view-title-kt">Post Dispatch Hand to Hand</span>
		                    	<span class="view-value-text">20</span>
		           	        </div>
		             	</div>
      ...
      <div class="kt-portlet__head-toolbar">
         <div class="kt-portlet__head-wrapper">
            <div class="kt-portlet__head-actions">
               <a href="add-courier.php" class="btn btn-brand btn-warning btn-elevate btn-icon-sm">
		 ...
		 <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="today_datatable" role="grid" aria-describedby="kt_table_1_info" style="width: 1147px;">
			<thead>
				 <tr role="row">
                        ...
                        <th class="sorting_asc" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 46.25px;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">YSK MEMBER</th>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 38.25px;" aria-label="Order ID: activate to sort column ascending">Courier Id</th>
			...
			<tbody>
				<tr role="row" class="odd">
                        ...
                        <td>1</td>
                        <td>
                        <span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill">Received</span>	
                        </td>
                        <td nowrap="">
                          <a href="view-courier.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
                           </a>
                            <a href="edit-courier.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="Edit">
                     ...
                     <tr role="row" class="odd">
                        ...
                        <td>2</td>
                        <td>
                        <span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill">Send</span>	
                        </td>        
                        <td nowrap="">
                          <a href="view-courier.php" class="btn btn-sm btn-clean btn-icon btn-icon-md datatable-icon" title="View">
                           <i class="la la-eye"></i>
