...
<body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading"  >
	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
					...
					<div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
						<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- "  >
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="55-year-old.php" class="kt-menu__link"><span class="kt-menu__link-text">55 Year Old</span></a></li>
						...
						<div class="kt-portlet__head-toolbar">
							<div class="kt-portlet__head-wrapper">
								<div class="kt-portlet__head-actions main-back">
									<a href="55-year-old.php" class="btn btn-clean btn-icon-sm back-tt">
        ...
        <div class="kt-portlet kt-portlet--tab">
        	...
        	<small class="text-box-alet">Lorem Ipsum is simply dummy text of the</small>
        	</div>
            </div>	
            ...
            <div class="col-lg-9">
          	<select class="form-control kt-select2" id="kt_select2_2" name="param">
                        <option value="AK">Select a Member</option>
            ...
            <div class="col-lg-9">
          	<select class="form-control kt-select2" id="kt_select2_3" name="param">
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">District
            <span class="text-danger">*</span>	
            </label>	
            <div class="col-lg-9">
            ...
            <div class="main-padding">
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">YSK Membership amount
            <span class="text-danger">*</span>	
            </label>	
            <div class="col-lg-9">
            ...
            <div class="col-lg-9">
          	<select class="form-control kt-select2" id="kt_select2_2_validate" name="param">
                        <option value="AK">Select Bank</option>
                        <option value="AK">Alaska</option>
                        <option value="HI">Hawaii</option>
                        <option value="CA">California</option>
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Samaj Zone
            <span class="text-danger">*</span>	
            </label>	
            <div class="col-lg-9">
            ...
            <div class="form-group1 m-form__group1 row">	
            <label class="col-lg-2 col-form-label">Yuva Mandal
            <span class="text-danger">*</span>	
            </label>	
            <div class="col-lg-9">
          	<select class="form-control kt-select2" id="kt_select2_7" name="param">
                        <option value="AK">Alaska</option>
                        <option value="HI">Hawaii</option>
                        <option value="CA">California</option>
                        <option value="NV">Nevada</option>
        ...
        <div class="form-group1 m-form__group1 row">	
        <label class="col-lg-2 col-form-label">Profile Upload</label>	
        <div class="col-lg-7">
        ...
        <img src="assets/img/300_3.jpg" id="profile1-img-tag">	
        	...
        	<div class="col-sm-6 col-md-6 difference-mt">
