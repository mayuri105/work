							                ...
							                <div class="col-md-10">
							                	<div class="tab-content">
									             	<div class="tab-pane active" id="tab-store">
														...
														<input type="hidden" name="merchant_id" id="merchant_id" value="<?php echo $this->session->userdata('m_id') ?>" class="form-control" required> 
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<input type="number" name="phone" value="<?= set_value('phone') ?>" maxlength="14" class="form-control">
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-3 control-label">Fax</label>
															<div class="col-sm-8">
																<input type="number" name="fax" value="<?= set_value('fax') ?>" class="form-control">
															</div>
														</div>
														<div class="form-group">
													...
													<div class="tab-pane" id="tab-address">
														...
														<div class="form-group ">
															...
															<div class="col-sm-8">
																...
																<select  name="store_city" id="storecity" class="" required >
																	...
																	<option value="<?= $ct->city_id; ?>"><?= $ct->city_name.' '.$ct->state; ?></option>
																<?php endforeach ?>
																</select>
														...
														<div class="form-group ">
															...
															<div class="col-sm-8">
																<input type="text" name="store_zip" value="<?= set_value('store_zip') ?>" required class="form-control">
															</div>
														</div>
