	...
	<div class="static-content">
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="mt-xl"></div> 
				<form  method="post" action="<?= site_url('store/updateproduct') ?>" id="form-customer" class="form-horizontal">
						                        ...
						                        <div class="tab-pane active" id="tab-products">
						                           <div class="pb"></div>
													...
													<div class="form-group">
														...
														<label class="col-sm-3 control-label">Small Product Description<span class="required">*</span></label>
														<div class="col-sm-8">
															<input type="text" name="small_desc" value="<?= $product->small_desc; ?>"  id="price" value="" class="form-control">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" name="pro_discount" value="<?= $product->discount; ?>"  id="pro_discount"  class="form-control" >
														</div>
													</div>
													
													<div class="form-group">
														<label class="col-sm-3 control-label">Discount Start Date</label>
														<div class="col-sm-8">
															<input type="text" name="pro_dis_start_date" id="pro_dis_start_date" value="<?= $product->start_time; ?>" class="form-control" >
														</div>
													</div>
													
													<div class="form-group">
														<label class="col-sm-3 control-label">Discount End Date</label>
														<div class="col-sm-8">
															<input type="text" name="pro_dis_end_date" id="pro_dis_start_date" value="<?= $product->end_time; ?>" class="form-control" >
														</div>
													</div>
