							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="name" value="<?php echo $name; ?>" placeholder="Product Name" id="input-name" class="form-control" autocomplete="off">
										<ul class="dropdown-menu"></ul>
									</div>
									<div class="form-group">
										<label class="control-label" for="input-merchant">Store name</label>
										<input type="text" name="store_name" value="<?php echo $store_name ?>" placeholder="Store name" id="input-merchant" class="form-control" autocomplete="off">
										<ul class="dropdown-menu"></ul>
									</div>
								</div>
								...
								<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<input type="text" name="cuisine" value="<?= $cuisine ?>" placeholder="Cuision" id="input-cuision" class="form-control">
									</div>
