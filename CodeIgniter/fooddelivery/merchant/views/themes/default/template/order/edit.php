											...
											<tr>
												...
												<td>
													...
													<?php foreach ($state as $st): ?>
														<option value="<?= $st->code ?>" <?= $orders->order->payment_state ? 'select' :'' ?>><?= $st->name ?></option>
													<?php endforeach ?>
													</select>
												</td>
											</tr>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<?php foreach ($state as $st): ?>
														<option value="<?= $st->code ?>" <?= $orders->order->shipping_state ? 'select' :'' ?>><?= $st->name ?></option>
													<?php endforeach ?>
													</select>
												</td>
											</tr>
