								...
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input type="text" name="order_id" value="<?= $order_id ?>" placeholder="Order Id" id="input-order_id" class="form-control" autocomplete="off">
											
										</div>
										<div class="form-group">
											<label class="control-label" for="input-ip">Customer</label>
											<input type="tel" name="customer" value="<?= $customer ?>" placeholder="customer" id="input-customer" class="form-control">
										</div>
									</div>
