...
<head>
    <meta charset="utf-8">
    <title><?= 'Merchant' ?> | <?= ucfirst($site_name) ?> </title>
...
<header id="topnav" class="navbar navbar-midnightblue navbar-static-top" role="banner">
    ...
    <div class="logo-area">
        ...
        <a class="navbar-brand" href="<?php echo base_url('index'); ?>"><?php echo $this->lang->line('Admin') ?></a>
    </div>
    <!-- logo-area -->
    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown toolbar-icon-bg hidden-xs " >
                <a href="#" id="readAllOrder" class="hasnotifications dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                    <span class="icon-bg"><i class="fa fa-ticket"></i></span>
                    <span class="badge badge-deeporange" id="countorder"><?= count($order); ?></span>
                </a>
                ...
                <div class="dropdown-menu notifications arrow">
                    ...
                    <div class="scroll-pane has-scrollbar">
                        <ul class="media-list scroll-content" id="order_list" tabindex="0" style="right: -17px;">
                            <?php if (!$order): ?>
                                <li class="media notification-message" >
                                    <a href="">
                            ...
                            <?php foreach ($order as $o): ?>
                                 <li class="media notification-message" >
                                    <a href="<?php echo site_url('orders/view/'.$o->o_id.'') ?>">
                                        <div class="media-body">
                                            <h4 class="notification-heading"><strong>You have ordered on <?= $o->store_name ?></strong> 
                                        </h4>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <div class="scroll-track" style="display: block;"><div class="scroll-thumb" style="height: 160px; transform: translate(0px, 0px);"></div></div>
                    </div>
