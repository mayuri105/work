    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
				...
				<li ><a href="<?= site_url('orders') ?>">Settings</a></li>
				<li class="active"><a href="">Profile Settings</a></li>
			</ol> 
			<div class="container-fluid">
				<form action="<?php echo site_url('index/updateprofile'); ?>" method="post" id="wizard" class="	form-horizontal">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="tab-merchant">
													   <div class="pb"></div>
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<textarea class="form-control" name="merchant_des" id="merchant_des"><?= trim($merchant->merchantinfo->merchant_des); ?></textarea>
																
															</div>
														</div>
														<div class="form-group">
															<label for="fieldurl" class="col-md-3 control-label">Phone<span class="required">*</span></label>
															<div class="col-md-6"><input id="phone" class="form-control"  type="text" name="phone" value="<?= $merchant->merchantinfo->phone; ?>" required></div>
														</div>

														<div class="form-group">
															<label for="fieldurl" class="col-md-3 control-label">Fax</label>
															<div class="col-md-6"><input id="fax" class="form-control"  type="text" name="fax" value="<?= $merchant->merchantinfo->fax; ?>"></div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input id="password" value="<?= $this->encrypt->decode($merchant->merchantinfo->password) ?>" class="form-control" name="password"  type="password" required>
															</div>
														</div>
													...
													<div class="tab-pane" id="tab-address">
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<textarea id="physical_street_1" class="form-control"  name="physical_street" required><?= trim($merchant->merchantinfo->physical_street) ?></textarea>
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																...
																<input id="physical_zipcode_1" class="form-control"  type="number" value="<?= $merchant->merchantinfo->physical_zip_code ?>" name="physical_zipcode" required>
														...
														<div class="form-group">
															...
															<div class="col-md-6"><input id="same_as_physical"  type="checkbox" name="same_as_physical" value="1"  <?= $merchant->merchantinfo->same_as_physical ? 'checked' :'' ?>></div>
														</div>
														<div class="form-group">
...
<script type="text/javascript">
	...
	$.ajax({
		url: '<?php echo site_url("index/getcity") ?>/' + element.value,
		dataType: 'json',
	...
	function zipcode(element, index) {
	$.ajax({
		url: '<?php echo site_url("index/getzipofcity") ?>/' + element.value,
		dataType: 'json',
		success: function(json) {
			html = '<option value="">--none--</option>';
			if ( json.length) {
			...
			if (index==1) {
				$('#physical_zipcode').html(html);
			} else{
				$('#billing_zipcode').html(html);
