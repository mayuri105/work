	   ...
	   <div class="static-content">
			 <div class="page-content">
				<ol class="breadcrumb">
					...
					<li class="active"><a href=""> Sale Report</a></li>
				</ol> 
				<div class="container-fluid">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-bar-chart"></i> Sale Report</h3>
						</div>
						<div class="panel-body">
							<div class="well">
								<div class="row">
								
									<form action="<?= site_url('reports/sale_report') ?>" method="get" name="filter">
										<div class="col-sm-4">
											...
											<div class="form-group">
												...
												<div class="checkbox">
												  <label><input type="checkbox" value="1" name="tip" <?php echo $tip == $tip ? 'checked' : '' ?>>Include Tip</label>
												</div>
											</div>
										...
										<div class="col-sm-4">
											...
											<div class="form-group">
												...
												<div class="checkbox">
												  <label><input type="checkbox" value="1" name="commission">Include Commission</label>
												</div>
											</div>
										</div>
										<div class="col-sm-4">
