...
<div class="static-content-wrapper">
								...
								<div class="row">
									...
									<form action="<?= site_url('reports/commission_report') ?>" method="get" name="filter">
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												<label class="control-label" for="input-status">Merchant</label>
												<select name="merchant" id="merchant" class="form-control">
													<option value="">None</option>
													<?php foreach ($merchant as $m): ?>
														<option value="<?= $m->m_id ?>" <?php echo $m->m_id == $merchant ? 'selected' : '' ?>><?= $m->business_name ?></option>
													<?php endforeach ?>
												</select>
											</div>
	...
	<script type="text/javascript">	
        ...
        $.plot("#chart-ad", [ { label: " Total Commisions", data: data1 } , { label: " Earning", data: data2} ], {
                shadowSize: 0,
