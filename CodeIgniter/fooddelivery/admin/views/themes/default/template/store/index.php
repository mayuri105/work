					...
					<div class="well">
						...
						<div class="row">
							<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="control-label" for="input-merchant">Merchant</label>
									<input type="text" name="merchant" value="<?= $merchant ?>" placeholder="Merchant" id="input-merchant" class="form-control" autocomplete="off">
									<ul class="dropdown-menu"></ul>
								</div>
							</div>
