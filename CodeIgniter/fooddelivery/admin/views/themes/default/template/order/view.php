										...
										<tbody>
											...
											<tr>
												...
												<td id="invoicegenerated">
													...
													?>
													<a href="<?php echo site_url('orders/printinvoice/'.$orders->order->o_id.''); ?>" class="btn btn-primary btn-xs pull-right"><i class="fa fa-print"></i> </a>
													<?php 
													else: ?>
											...
											<tr>
												...
												<td id="payment">
													...
													<?php if ($orders->order->payment_status): 
														echo 'Payment Done';
													?>
													<?php 
													else: ?>
													<button id="button-payment" class="btn btn-success btn-xs">
...
<script type="text/javascript">
	...
	$('#button-payment').click(function(){
		...
		$.ajax({
			url : "<?php echo site_url('orders/paymentupdate') ?>",
			type: "POST",
			dataType: 'json',
			data:data,
			success:function(data){
