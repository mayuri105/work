...
<head>
  ...
  <title>JMD| View W T Protection Claim </title>
...
<body onload="window.print();" style="margin-left:30px">
<div class="wrapper">
  <!-- Main content -->
