...
<head>
  ...
  <title>JMD| Edit W T Protection</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit  W T Protection</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit W T Protection</h3>
            </div>
          ...
          <?php 
            ...
            $attributes = array('id' => 'cars');
             ...
             echo form_open_multipart('wtf/update', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" value="<?= $cares->wtp_id ?>" name="wtp_id">
              ...
              <div class="col-xs-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Kilometer" id="km" name="km"  value="<?= $cares->km ?>">
                </div>
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
                  <label>Amount</label>
                  <input type="text" class="form-control" placeholder="Amount" id="amount" name="amount"   readonly="readonly" value="<?= $cares->amount ?>">
                </div>
                </div>
                  <div class="col-xs-12">
                <div class="col-xs-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="SGST(<?php echo $gst;?>%)" id="tax1per" name="sgst"   readonly="readonly"  value="<?= $cares->sgst ?>">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                  <label>CGST(<?php echo $gst;?>%)</label>
                  <input type="text" class="form-control" placeholder="CGST(<?php echo $gst;?>%)" name="cgst" id="tax2per"   readonly="readonly" value="<?= $cares->cgst ?>">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                  <label>Total Amount Rupees</label>
                  <input type="text" class="form-control" placeholder="Total Amount Rupees"  id="total_amt" name="total_amt"  value="<?= $cares->total_amt ?>">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Customer GSTIN NO" name="gstin_no" value="<?= $cares->gstin_no ?>">
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
