...
<head>
  ...
  <title>JMD| Add JMD’s W T Protection</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add  JMD’s W T Protection</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add JMD’s W T Protection</h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('wtf/addwtf', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
                <div class="form-group">
                  <label>Certificate Date</label>
                   <input type="text" class="form-control" name="certificate_date" placeholder="Certificate Date">
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Registration Date</label>
                   <input type="text" class="form-control"  placeholder="Registration Date" name="registration_date">
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
                  <label>Make / Model / Variant</label>
                   <input type="text" class="form-control" placeholder="Make / Model / Variant" name="model">
                </div>
                </div>
                ...
                <label>Period of Benifit Availability</label>
                 ...
                 <div class="form-group">
                  <div class="col-xs-6">
                  <input type="text" class="form-control"  placeholder="From Date" name="benifit_fromdate"> 
              </div> 
              <div class="col-xs-6"> <input type="text" class="form-control"  placeholder="To  Date" name="benifit_todate"></div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Kilometer" id="km"  name="km">
                </div>
                </div>
                 </div>
                  <div class="col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="SGST(<?php echo $gst;?>%)" readonly="readonly" id="tax1per" name="sgst">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Mode of payment" name="payment_mode">
                </div>
                </div>
