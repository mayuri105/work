...
<head>
  ...
  <title>JMD| Add JMD’s W T Protection Claims</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add  JMD’s W T Protection Claims</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add  JMD’s W T Protection Claims</h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('wtf/addclaims', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" name="wtp_id" value="<?php echo $caresclaims->wtp_id ?>">
                <input type="hidden" id="cares_amount" name="cares_amount" value="<?php echo $caresclaims->profitvalue ?>">
                <div class="form-group">
                  <label>Certificate Date</label>
                   <input type="text" class="form-control" name="certi_date" readonly="readonly" placeholder="Certificate Date" value="<?php echo $caresclaims->certificate_date ?>" >
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
                  <label>Claim Date</label>
                  <input type="text" class="form-control" name="claim_date"  placeholder="Claim Date">
                </div>
                  </div>
                 <div class="col-xs-6">
                <div class="form-group">
                  <label>Customer Name</label>
                  <input type="text" class="form-control" placeholder="Customer Name" name="customer" value="<?php echo $caresclaims->name ?>" readonly="readonly">
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
                  <label>Invoice No</label>
                  <input type="text" class="form-control" placeholder="Invoice No" name="invoiceno">
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Vehicle No" name="vehicleno">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                  <label>Insurance Laibility</label>
                  <input type="text" class="form-control" placeholder="Insurance Laibility" id="insurancelaibility" name="insurancelaibility">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
                  <label>Customer Laibility</label>
                   <input type="text" class="form-control" id="customerlaibility"  placeholder="Customer Laibility" name="customerlaibility">
                </div>
                </div>
                 <div class="col-xs-3">
                <div class="form-group">
                  <label>Total Amount</label>
                   <input type="text" class="form-control" id="totalamt" placeholder="Total Amount" readonly="readonly" name="totalamt">
                </div>
                </div>
                </div>
