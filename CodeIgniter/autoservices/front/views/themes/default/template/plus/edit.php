  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit JMD PMS </li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit JMD PMS </h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('plus/update', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" value="<?= $plus->plus_id ?>" name="plus_id">
                <div class="form-group">
                  <label>Certificate No</label>
                   <input type="text" class="form-control" name="certificate_no" placeholder="Certificate No" value="<?= $plus->certificate_no ?>">
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
                  <label>Certificate Date</label>
                  <input type="text" class="form-control" name="certi_date"  placeholder="Certificate Date" value="<?= $plus->certi_date ?>">
                </div>
                  </div>
                 <div class="col-xs-6">
                <div class="form-group">
                  <label>Beneficiary Name</label>
                  <input type="text" class="form-control" placeholder="Beneficiary Name" name="ben_name" value="<?= $plus->ben_name ?>">
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
                  <label> Beneficiary Mobile No</label>
                  <input type="text" class="form-control" placeholder="Beneficiary Mobile No" name="ben_mobno" value="<?= $plus->ben_mobno ?>">
                </div>
                </div>
                 <div class="col-xs-12">
                <div class="form-group">
                  <label> Beneficiary Address</label>
                  <textarea class="form-control" placeholder="Beneficiary Address" name="ben_addr"><?= $plus->ben_addr ?></textarea>
                </div>
                </div>
                 <div class="col-xs-12">
                <div class="col-xs-4">
                ...
                <div class="col-xs-12">
                  ...
                  <input type="text" class="form-control"  value="<?= $plus->certi_fromdate ?>" placeholder="Certificate From Date" name="certi_fromdate"> 
              </div> 
               </div> 
              <div class="col-xs-4"> 
               <div class="form-group">
               <label>Plan valid to</label>
              <input type="text" class="form-control" value="<?= $plus->certi_todate ?>"  placeholder=" Certificate To  Date" name="certi_todate">
              </div>
              </div>
              <div class="col-xs-4"> 
               <div class="form-group">
              ...
              <input type="text" class="form-control" value="<?= $plus->km ?>"  placeholder=" Kilometer" name="km">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control"  name="fileinput"><?= $plus->terms ?>
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
                  <label>Customer GSTIN NO</label>
                  <input type="text" class="form-control" value="<?= $plus->gstin_no ?>" placeholder="Customer GSTIN NO" name="gstin_no">
                </div>
                </div>
              </div>
