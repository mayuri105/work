...
border-left: 2px solid black;
    box-sizing: border-box;
      ...
      margin: 20px;"><h3> JMD's Service Schield Scheme</h3> </center>
    ...
    box-sizing: border-box;
     ...
     padding:  20px;
         margin-top: -20px;">
        <small class="pull-left"><b>Date: <?php $var = $plus->certi_date;
echo date("d-m-Y", strtotime($var) );  ?></b></small>
<small style="right:90px; position: absolute;"><b>JMD SHIELD NO :<?= $plus->certificate_no ?></b></small><br>
...
<?= $plus->reg_no ?>     
 ...
 <?= $plus->make ?>
      ...
      <?php   $from= date_create($plus->certi_fromdate);
$to= date_create($plus->certi_todate);
