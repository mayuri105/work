...
<head>
  ...
  <title>JMD| Edit Membership</title>
        ...
        <div class="col-xs-12">
         <br>
          ...
          <?php 
            ...
            echo form_open_multipart('membership/update', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
              <div class="col-xs-12">
               <div class="col-xs-4">
                <input type="hidden" value="<?= $membership->membership_id ?>" name="membership_id">
                
                <div class="form-group">
                  <label>Card No</label>
                   <input type="text" class="form-control" name="card_no" value="<?= $membership->card_no ?>" placeholder="Card No">
                </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Customer Name" value="<?= $membership->customer ?>" name="customer">
                </div>
                </div>
                <div class="col-xs-4">
                <div class="form-group">
                  <label>Mobile No</label>
                  <input type="text" class="form-control" placeholder="Mobile No" value="<?= $membership->mob_no ?>" name="mob_no">
                </div>
                </div>
                  </div>
                 <div class="col-xs-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" placeholder="Address" name="address"><?= $membership->address ?></textarea>
                </div>
                </div>
                   <div class="col-xs-12">
                <div class="col-xs-4">
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control" value="<?= $membership->email ?>" placeholder="Email" name="email">
                </div>
                </div>
                <div class="col-xs-4">
                <div class="form-group">
                  <label>Issue Date</label>
                  <input type="text" class="form-control" name="birthdate" value="<?= $membership->birthdate ?>"  placeholder="Birth Date">
                </div>
                  </div>
                <div class="col-xs-4">
                <div class="form-group">
                  <label>Registration No. of Car under the scheme</label>
                  <input type="text" class="form-control" placeholder="Registration No" value="<?= $membership->reg_no ?>" name="reg_no">
                </div>
                </div>
                </div>
                <div class="col-xs-6">
                <label>Validity Period</label>
                 <div class="form-group">
                  <div class="col-xs-6">
                  <strong>From:</strong><input type="text" class="form-control" value="<?= $membership->fromdate ?>"  placeholder="Validity From Date" name="fromdate"> 
              </div> 
              <div class="col-xs-6"> 
              <strong>To:  </strong><input type="text" class="form-control"  value="<?= $membership->todate ?>" placeholder=" Validity To  Date" name="todate">
              </div>
              </div>
            </div>
               <div class="col-xs-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?= $membership->gstin_no ?>" placeholder="Customer GSTIN NO" name="gstin_no">
                </div>
                </div>
              </div>
