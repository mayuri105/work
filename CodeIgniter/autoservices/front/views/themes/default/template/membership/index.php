     ...
     <?php echo Modules::run('messages/message/index'); ?>
      <div class="box-header with-border">
            ...
            <div class="row">
                    ...
                    <form action="<?=  site_url('membership'); ?>" method="get" name="filter">
                      <div class="row">
                      ...
                      <div class="col-xs-12">
                       ...
                       <div class="col-xs-3">
                           <?php if($userp == 2){ ?>
                        <a href="<?= site_url('membership/add') ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add Membership</a>
                        <?php } ?>
                         </div>
                          <div class="col-xs-3">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php  echo $ct->reg_no?></td>
                   <td><a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url('membership/view/'.$ct->membership_id.'') ?>">View</a></td>
                   
                      <td>
                          <?php if($userp == 2){ ?>
                      <a href="<?php echo site_url('membership/edit/'.$ct->membership_id.'') ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-primary btn-xs delete"  href="<?php echo site_url('membership/membershipdelete/'.$ct->membership_id.'') ?>" > <i class="fa fa-trash"></i></a>
                      <?php } ?>
                      </td>
                </tr>
                 <?php endforeach ?>
                    <?php else: ?>
                    <tr>
                      <td colspan="4">No Membership Data found</td>
                    </tr>
                    <?php endif ?>
                     </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="3"><ul class="pagination">
