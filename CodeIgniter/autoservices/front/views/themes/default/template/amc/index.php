    ...
    <section class="content">
     ...
     <?php echo Modules::run('messages/message/index'); ?>
      <div class="box-header with-border">
              <h3 class="box-title">JMD AMC</h3>
            </div>
           <?php if($userp == 2){ ?>
           <a href="<?= site_url('amc/add') ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add AMC</a>
           <?php }?>
            <thead>
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php  echo $ct->registration_date?></td>
                   ...
                   <td><a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url('amc/view/'.$ct->amc_id.'') ?>">View</a></td>
                   
                      <td>
                           <?php if($userp == 2){ ?>
                      <a href="<?php echo site_url('amc/edit/'.$ct->amc_id.'') ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-primary btn-xs delete"  href="<?php echo site_url('amc/amcdelete/'.$ct->amc_id.'') ?>" > <i class="fa fa-trash"></i></a>
                        <?php }?>
                      </td>
                </tr>
                 <?php endforeach ?>
                    <?php else: ?>
                    <tr>
                      <td colspan="5">No AMC Plan found</td>
                    </tr>
                    <?php endif ?>
                     </tbody>
                  <tfoot>
