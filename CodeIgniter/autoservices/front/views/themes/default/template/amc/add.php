  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add JMD AMC</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add JMD AMC</h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('amc/addamc', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Beneficiary Name" name="customer">
                </div>
                </div>
                <div class="col-xs-6">
                <div class="form-group">
                  <label> Beneficiary Mobile No</label>
                  <input type="text" class="form-control" placeholder="Beneficiary Mobile No" name="mob_no">
                </div>
                </div>
                 <div class="col-xs-12">
                <div class="form-group">
                  <label> Beneficiary Address</label>
                  <textarea class="form-control" placeholder="Beneficiary Address" name="address"></textarea>
                </div>
                </div>
                <div class="col-xs-12">
                <div class="col-xs-4">
                ...
                <div class="col-xs-12">
                  ...
                  <input type="text" class="form-control"  placeholder="Certificate From Date" name="validity_from_date"> 
              </div> 
               </div> 
              <div class="col-xs-4"> 
               <div class="form-group">
               <label>Plan valid to</label>
              <input type="text" class="form-control"  placeholder=" Certificate To  Date" name="validity_to_date">
              </div>
              </div>
              <div class="col-xs-4"> 
               <div class="form-group">
              ...
              <input type="text" class="form-control"  placeholder=" Kilometer" name="km">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Date of Registration" name="registration_date">
                </div>
                </div>
                 <div class="col-xs-6">
                <div class="form-group">
