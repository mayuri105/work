    ...
    <section class="content">
     ...
     <?php echo Modules::run('messages/message/index'); ?>
      <div class="box-header with-border">
              <h3 class="box-title">Cares</h3>
            </div>
            <div class="row">
             
                    <form action="<?=  site_url('cares'); ?>" method="get" name="filter">
                      <div class="row">
                      ...
                      <div class="col-xs-12">
                       ...
                       <div class="col-xs-2">
                           <?php if($userp == 2){ ?>
                        <a href="<?= site_url('cares/add') ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add Cares</a>
                           <?php }?>
                         </div>
                          <div class="col-xs-2">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php  echo $ct->total_amt?></td>
                   ...
                   <td> <?php if($ct->terms):?><a href="<?php echo getuploadpath().'termscondition/'.$ct->terms; ?>" target="_blank"><i class="fa fa-eye"></i></a><?php endif ?></td>
                   <td><a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url('cares/view/'.$ct->car_id.'') ?>">View</a></td>
                   <td>  <a href="<?php echo site_url('cares/claims/'.$ct->car_id.'') ?>" class="btn btn-primary btn-xs"> claims</a></td>
                    <td> 
                      <?php if($userp == 2){ ?>
                      <a href="<?php echo site_url('cares/edit/'.$ct->car_id.'') ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-primary btn-xs delete"  href="<?php echo site_url('cares/cardelete/'.$ct->car_id.'') ?>" > <i class="fa fa-trash"></i></a>
                         <?php }?>
                      </td>
                </tr>
                 <?php endforeach ?>
                    <?php else: ?>
                    <tr>
                      <td colspan="7">No Cares Data found</td>
                    </tr>
                    <?php endif ?>
                     </tbody>
                  <tfoot>
