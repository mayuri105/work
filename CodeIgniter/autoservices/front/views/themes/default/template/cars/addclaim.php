        ...
        <div class="col-xs-12">
         <br>
          ...
          <?php 
            ...
            echo form_open_multipart('cares/addclaims', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" name="cares_id" value="<?php echo $caresclaims->car_id ?>">
              ...
              <div class="box-footer">
                  <a href="<?= site_url('cares') ?>" class="btn btn-primary">Cancel</a>
