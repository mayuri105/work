    ...
    <section class="content">
     ...
     <?php echo Modules::run('messages/message/index'); ?>
      <div class="box-header with-border">
              <h3 class="box-title"><strong>Claim</strong></h3>
            </div>
            <div class="row">
             
                    <form action="<?=  site_url('cares/claims/'.$id.''); ?>" method="get" name="filter">
                      <div class="row">
                      ...
                      <div class="col-xs-12">
                       ...
                       <?php if (count($claims) < 3 ): ?>
                        <?php if($userp == 2){ ?>
                        <a href="<?= site_url('cares/addclaim/'.$id.'') ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add Cliam</a>
                          <?php }?>
                        <?php endif ?>
                         </div>
                          <div class="col-xs-2">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php  echo $ct->customerlaibility?></td>
                   ...
                   <td><a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url('cares/viewclaim/'.$ct->cares_claim_id.'') ?>">View</a></td>
                   
                     <td>
                          <?php if($userp == 2){ ?>
                      <a href="<?php echo site_url('cares/editclaim/'.$ct->cares_claim_id.'') ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-primary btn-xs delete"  href="<?php echo site_url('cares/claimdelete/'.$ct->cares_claim_id.'') ?>" > <i class="fa fa-trash"></i></a>
                      <?php } ?>
                      </td>
                </tr>
                 <?php endforeach ?>
