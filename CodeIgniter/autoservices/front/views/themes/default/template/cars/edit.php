         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Cares</h3>
            </div>
          ...
          <?php 
            ...
            $attributes = array('id' => 'cars');
             ...
             echo form_open_multipart('cares/update', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" value="<?= $cares->car_id ?>" name="car_id">
              ...
              <div class="col-xs-6"> <input type="text" class="form-control"  placeholder="To  Date" name="benifit_todate"  value="<?= $cares->benifit_todate ?>"></div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="CGST(%)" name="cgst"  readonly="readonly" id="tax2per" value="<?= $cares->cgst ?>"  >
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
