  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit  Claims</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Claims</h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('cares/updateclaims', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" name="cares_claim_id" value="<?php echo $claims->cares_claim_id ?>">
                <input type="hidden" name="cares_id" value="<?php echo $claims->cares_id ?>">
                <?php
                $CI =& get_instance();
$CI->load->model('cars_model');
$result = $CI->cars_model->getclaimbycaresid($claims->cares_id);
