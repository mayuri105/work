  ...
  /*--This JavaScript method for Print command--*/
    function PrintDoc() {
        ...
        popupWin.document.write('<html><head><title>::Preview:JMD VFM:</title></head><body onload="window.print()">')
  ...
  /*--This JavaScript method for Print Preview command--*/
    function PrintPreview() {
        ...
        var popupWin = window.open();
        popupWin.document.open();
        popupWin.document.write('<html>html><title>::Preview:JMD VFM:</title>');
        popupWin.document.write(toPrint.innerHTML);
        popupWin.document.write('</html>');
        popupWin.document.close();
    }
...
.col-sm-1 {
  ...
  border-left: 2px solid black;
    box-sizing: border-box;
     padding:  20px;
      margin: 20px;"><h3> JMD VFM PLAN</h3></center>
...
<?= $cares->gstin_no ?>    
      ...
      <div class="col-sm-2">
       ...
       <?= $cares->payment_mode ?> <span>Cash / Cheque / Other - Subject to realization of payment.</span></div>
        ...
        <div class="col-sm-12"><b>N.B. - T & C Apply.</b></div><br>
         <div class="col-sm-12">
        <p style="position: absolute;
    right: 100px;"><strong  style="margin-left:25px";>For JMD Auto India Pvt. Ltd.</strong><br><br><br><br>
