        ...
        <div class="col-xs-12">
         <br>
          ...
          <?php 
            ...
            echo form_open_multipart('vfm/addvfm', $attributes);  ?>
              <div class="box-body">
              ...
              <div class="col-xs-6"> <input type="text" class="form-control"  placeholder="To  Date" name="benifit_todate"></div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="CGST(<?php echo $gst;?>%)" readonly="readonly"  id="tax2per" name="cgst">
                </div>
                </div>
                <div class="col-xs-3">
                <div class="form-group">
