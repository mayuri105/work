    ...
    <section class="content">
     ...
     <?php echo Modules::run('messages/message/index'); ?>
      <div class="box-header with-border">
              <h3 class="box-title">VFM</h3>
            </div>
            <div class="row">
             
                    <form action="<?=  site_url('vfm'); ?>" method="get" name="filter">
                      <div class="row">
                      ...
                      <div class="col-xs-12">
                       ...
                       <div class="col-xs-2">
                            <?php if($userp == 2){ ?>
                        <a href="<?= site_url('vfm/add') ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add VFM</a>
                        <?php } ?>
                         </div>
                          <div class="col-xs-2">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php  echo $ct->total_amt?></td>
                   ...
                   <td><a href="<?php echo getuploadpath().'vfmtermscondition/'.$ct->terms; ?>" target="_blank"><i class="fa fa-eye"></i></a></td>
                   <td><a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url('vfm/view/'.$ct->vfm_id.'') ?>">View</a></td>
                   <td>  <a href="<?php echo site_url('vfm/claims/'.$ct->vfm_id.'') ?>" class="btn btn-primary btn-xs"> claims</a></td>
                    <td> 
                      <?php if($userp == 2){ ?>
                      <a href="<?php echo site_url('vfm/edit/'.$ct->vfm_id.'') ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-primary btn-xs delete"  href="<?php echo site_url('vfm/vfmdelete/'.$ct->vfm_id.'') ?>" > <i class="fa fa-trash"></i></a>
                      <?php } ?>
                      </td>
                </tr>
                 <?php endforeach ?>
                    <?php else: ?>
                    <tr>
                      <td colspan="7">No VFM Data found</td>
                    </tr>
                    <?php endif ?>
                     </tbody>
                  <tfoot>
