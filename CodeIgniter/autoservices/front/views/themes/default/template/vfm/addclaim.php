...
<head>
  ...
  <title>JMD| Add VFM Claims</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add  VFM Claims</li>
      </ol>
    </section>
         ...
         <br>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add VFM Claims</h3>
            </div>
          ...
          <?php 
            ...
            echo form_open_multipart('vfm/addclaims', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" name="vfm_id" value="<?php echo $caresclaims->vfm_id ?>">
