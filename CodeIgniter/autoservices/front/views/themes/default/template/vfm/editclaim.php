        ...
        <div class="col-xs-12">
         <br>
          ...
          <?php 
            ...
            echo form_open_multipart('vfm/updateclaims', $attributes);  ?>
              <div class="box-body">
              <?php echo Modules::run('messages/message/index'); ?>
               <div class="col-xs-6">
               <input type="hidden" name="vfm_claim_id" value="<?php echo $claims->vfm_claim_id ?>">
                <input type="hidden" name="vfm_id" value="<?php echo $claims->vfm_id ?>">
                <?php
                $CI =& get_instance();
$CI->load->model('vfm_model');
$result = $CI->vfm_model->getclaimbycaresid($claims->vfm_id);
