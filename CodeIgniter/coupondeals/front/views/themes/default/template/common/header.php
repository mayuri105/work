    ...
    <div class="container_grid clearfix">
      <div class="grid_12">
        <div class="header-content clearfix">
          <h1 id="logo" class="rs"> <a href="<?=site_url('home');?>"> <img src="<?=site_url('front/views/themes/default');?>/asset/images/logo.png" height="100" alt="" /> </a> </h1>
            <?php if (is_login()): ?>
    ...
    <div class="viewport-pop">
      <div class="transport-viewer clearfix">
        <div class="mod-register">
          <h3 class="rs title-mod">Hello pretty! Welcome to Savetakatak.com</h3>
...
<script>
      window.fbAsyncInit = function() {
        FB.init({
          appId: '1762991843980515',
		  channelUrl : 'http://prometheantechtest2.online/login/fblogin',
          cookie: true,
          xfbml: true,
          oauth: true
        });
