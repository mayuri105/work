...
class News extends MX_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('news_models', 'news');
	...
	public function index() {
		...
		*/
		...
		//load view
		if (file_exists(APPPATH . 'views/themes/' . $theme . '/template/news/index')) {
			$this->load->view('themes/' . $theme . '/template/news/index', $data);
		} else {
			$this->load->view('themes/default/template/news/index', $data);
	...
	public function addnews() {
		...
		//load view
		if (file_exists(APPPATH . 'views/themes/' . $theme . '/template/news/add')) {
			$this->load->view('themes/' . $theme . '/template/news/add', $data);
		} else {
			$this->load->view('themes/default/template/news/add', $data);
