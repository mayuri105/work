      ...
      <div class="col-md-6">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('categories/addcat') ?>" class="btn blue"> ADD <i class="fa fa-plus"></i> </a> </div>
            <div class="tools"></div>
              ...
              <?php if ($categories): ?>
                ...
                <tr>
                 <td><?php echo $ct->cat_name ?> </td>
                  ...
                  <td><a href="<?php echo site_url('categories/edit/'.$ct->cat_id.'') ?>"><i class="fa fa-pencil-square-o"></i><a class="delete"  href="<?php echo site_url('categories/delete/'.$ct->cat_id.'') ?>" > <i class="fa fa-trash"></i></a></td>
                </tr>
                  <?php endforeach ?>
                  <?php else: ?>
                  <tr>
...
<div id="static3" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" data-attention-animation="false">
              <div class="modal-body">
                <p>Add Category</p>
                <input class="form-control" type="text" data-tabindex="1" placeholder="Category Name" value="Cloth">
              </div>
              <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-outline dark">Cancel</button>
                <button type="button" data-dismiss="modal" class="btn green">Change</button>
              </div>
            </div>
