      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            ...
            echo form_open_multipart('pages/updatepage', $attributes);  ?>
                <div class="form-body">
                <input type="hidden" value="<?= $pages->page_id ?>" name="page_id">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="name" id="name" value="<?= $pages->name ?>" readonly>
                    </div>
                  </div>
                  
                  <?php  $uploadsee_path =  $this->config->item('show_upload_path').'/pagesimages/';?>
                  <div class="form-group ">
                    <label class="control-label col-md-3">Image </label>
                    <div class="col-md-9">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 520px; height: 170px;"> <img src="<?= $uploadsee_path.$pages->img_name;?>"> </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="description" id="summernote_1"><?= $pages->description ?> </textarea>
                    </div>
                  </div>
