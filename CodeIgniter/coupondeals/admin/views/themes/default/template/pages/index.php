      ...
      <div class="col-md-12">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('pages/addpage') ?>" class="btn blue"> ADD Page <i class="fa fa-plus"></i> </a> </div>
            <div class="tools"></div>
          </div>
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
              ...
              <tbody>
               <?php if ($pages): ?>
                  <?php foreach ($pages as $ct): ?>
                <tr>
                  <td><?php  echo $ct->name?> </td>
                  <td><?php  echo $ct->description?></td>
                  <td><?php  echo $ct->added_date?> </td>
                  <td><a href="<?php echo site_url('pages/edit/'.$ct->page_id.'') ?>"><i class="fa fa-pencil-square-o"></i></a><a class="delete"  href="<?php echo site_url('pages/delete/'.$ct->page_id.'') ?>" >  <i class="fa fa-trash"></i></a></td>
                </tr>
