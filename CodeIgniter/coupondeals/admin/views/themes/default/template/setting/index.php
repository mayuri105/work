...
<head>
<meta charset="utf-8" />
<title>Savetakatak| Theme Option</title>
        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Change  Option</span> </div>
            </div>
            <div class="portlet-body">
              <?php 
            $attributes = array('class' => 'form-horizontal', 'id' => 'page');
            echo form_open_multipart('users/savethemeoption', $attributes);  ?>
                <div class="form-body">
                  
                  
                  <div class="form-group">
                    <label class="control-label col-md-3">Video <span class="required"> * </span> </label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="video_link" id="video_link" size="10" value="<?php echo $video_link; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="aboutus" id="aboutus" cols="60" rows="5"><?php echo $aboutus; ?></textarea>
                    </div>
                  </div>
