      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet light portlet-fit portlet-form ">
            ...
            echo form_open_multipart('deals/add', $attributes);  ?>
              ...
              <div class="form-body">
                ...
                <div class="form-group price">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-medium margin-top-10 col-md-4">
                      ...
                      <input class="price" type="text" name="orignal_price" id="orignal_price" placeholder="Orignal Price"/>

                      <span class="input-group-addon"> <i class="fa fa-rupee"></i> </span> </div>

                    <!--<div class="input-group input-medium margin-top-10 col-md-4">

                      <input class="rate" type="text" name="discount" id="discount" placeholder="Discount rate %"/>

                      <span class="input-group-addon">% <i class="fa fa-percent"></i> </span> </div>-->

                    <div class="input-group input-medium margin-top-10 col-md-4">

                      <input class="total" type="text"  name="total_price" id="total_price" placeholder="Discount Price Total" />
                ...
                <!--<div class="form-group price">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-medium margin-top-10 col-md-4">
                      ...
                      <input class="price" type="text" name="orignal_price" id="orignal_price" placeholder="Unit price"/>
                    ...
                    <div class="input-group input-medium margin-top-10 col-md-4">
                      ...
                      <input class="total" type="text"  name="total_price" id="total_price" placeholder="Total" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea  name="long_desc" id="summernote_1"></textarea>
                ...
                <div class="form-group form-md-checkboxes">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-checkbox">
                      ...
                      <label>Set As Hot Deal </label>

                      <input id="checkbox6" class="md-check" type="checkbox" value="1" name="hotdeal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" name="deal_url" id="deal_url">
