        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Edit  Blog</span> </div>
            </div>
            <div class="portlet-body">
               <?php 
            $attributes = array('class' => 'form-horizontal', 'id' => 'blogs');
            echo form_open_multipart('blogs/updateblog', $attributes);  ?>
                <div class="form-body">
                <input type="hidden" value="<?= $blogs->blog_id ?>" name="blog_id">
                
                <div class="form-group">
                    <label class="control-label col-md-3">Category <span class="required"> * </span> </label>
                    <div class="col-md-4">
                      <select class="form-control select2me" name="cat_slug" id="cat_slug">
                        
                    <?php foreach ($categories as $l): ?>
                   
                            <option value="<?= $l->blog_cat_slug ?>"  <?= $blogs->cat_slug == $l->blog_cat_slug ? 'selected': '' ?>><?= $l->blog_cat_name ?></option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="title" id="title" value="<?= $blogs->title ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Short Description </label>
                    <div class="col-md-6">
                      <textarea name="short_desc" id="short_desc" cols="72" rows="6"><?= $blogs->short_desc ?></textarea>
                    </div>
                  </div>
                  <?php  $uploadsee_path =  $this->config->item('show_upload_path').'/blogsimages/';?>
                  <div class="form-group ">
                    <label class="control-label col-md-3">Image </label>
                    <div class="col-md-9">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 520px; height: 170px;"> <img src="<?= $uploadsee_path.$blogs->img_name;?>"> </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="long_desc" id="summernote_1"><?= $blogs->long_desc ?> </textarea>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="md-checkbox">
                      <label>Set As Feature Brand</label>
                      <input id="checkbox6" class="md-check" type="checkbox"  name="feature"  <?= $blogs->feature == 1 ? 'checked': '' ?> value="1">
                      <label for="checkbox6"> <span class="inc"></span> <span class="check"></span> <span class="box"></span></label>
                    </div>
                  </div>
                </div>
                </div>
