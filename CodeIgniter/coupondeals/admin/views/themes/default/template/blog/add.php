        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Add  Blog</span> </div>
            </div>
             <?php echo Modules::run('messages/message/index'); ?>
            <div class="portlet-body">
               <?php 
            $attributes = array('class' => 'form-horizontal', 'id' => 'blog');
            echo form_open_multipart('blogs/add', $attributes);  ?>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="short_desc" id="short_desc" cols="60" rows="6"></textarea>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="col-md-6">
                    <div class="md-checkbox">
                      ...
                      <input class="md-check" type="checkbox" value="1" name="feature" id="checkbox6">
