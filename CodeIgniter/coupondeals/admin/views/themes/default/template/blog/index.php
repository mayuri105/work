      ...
      <div class="col-md-12">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('blogs/addblog') ?>" class="btn blue"> ADD Blog <i class="fa fa-plus"></i> </a> </div>
            <div class="tools"></div>
          </div>
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%">
              ...
              <tbody>
               <?php if ($blogs): ?>
                  <?php foreach ($blogs as $ct): ?>
                <tr>
                  <td><?php  echo $ct->title?> </td>
                  <td><?php  echo $ct->blog_cat_name?></td>
                 
                  <td><?php  echo $ct->added_date?> </td>
                  <td><a class="btn btn-success inactive" href="<?php echo site_url('blogs/status/'.$ct->blog_id.'') ?>">
                        <?php if ( $ct->status==1): echo "Active" ;?>
                        <?php else: echo "Inactive "; ?>
                        <?php endif ?>
                    </a></td>
                  <td><a href="<?php echo site_url('blogs/edit/'.$ct->blog_id.'') ?>"><i class="fa fa-pencil-square-o"></i></a><a class="delete"  href="<?php echo site_url('blogs/delete/'.$ct->blog_id.'') ?>" >  <i class="fa fa-trash"></i></a></td>
                </tr>
