...
<head>
<meta charset="utf-8" />
<title>Savetakatak| Coupon</title>
        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Edit  Category</span> </div>
            </div>
            <div class="portlet-body">
              <?php 
            $attributes = array('class' => 'form-horizontal', 'id' => 'brands');
            echo form_open_multipart('coupons/updatecoupon', $attributes);  ?>
              <div class="form-body">
                <input type="hidden" value="<?= $coupons->coupon_id ?>" name="coupon_id">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <select class="form-control select2me" name="brand_id" id="brand_id">
                       ...
                       <?php foreach ($brands as $b): ?>
                            ...
                            <option value="<?= $b->brand_id ?>"  <?= $coupons->brand_id == $b->brand_id ? 'selected': '' ?>><?= $b->brand_name ?></option>
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" name="title" id="title" value="<?= $coupons->title ?>">
                  </div>
                </div>
                 <div class="form-group">
                  <label class="control-label col-md-3">Coupon Code</label>
                  <div class="col-md-6">
                    <input type="text" name="coupon_code" id="coupon_code" value="<?= $coupons->coupon_code ?>" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3">Short Description </label>
                  <div class="col-md-6">
                    <textarea name="coupon_desc" id="coupon_desc" cols="60" rows="5"><?= $coupons->coupon_desc ?>
</textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" name="coupon_link" id="coupon_link" value="<?= $coupons->coupon_link ?>">
                  </div>
                </div>
                 <div class="form-group">
                                                            <label class="control-label col-md-4">Start From</label>
                                                            <div class="col-md-8">
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                                    <input type="text" class="form-control" readonly name="start_date" id="start_date" value="<?= $coupons->start_date ?>">
              	 ...
              	 <div class="form-group">
                                                            <label class="control-label col-md-4">Valid Still</label>
                                                            <div class="col-md-8">
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                                    <input type="text" class="form-control" readonly name="expired_date" id="expired_date"  value="<?= $coupons->expired_date ?>" >
                                                                    <span class="input-group-btn">
                                                                        <button class="btn default" type="button">
                                                                            <i class="fa fa-calendar"></i>
                                                                        </button>
