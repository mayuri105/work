...
<head>
<meta charset="utf-8" />
<title>Savetakatak| Coupons</title>
...
<link href="<?= site_url('views/themes/default') ?>/assets/global/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css" rel="stylesheet" type="text/css" />
<link href="<?= site_url('views/themes/default') ?>/assets/global/plugins/sweet-alert/sweet-alert.css" rel="stylesheet" type="text/css" />
<link href="<?= site_url('views/themes/default') ?>/assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet" type="text/css" />
      ...
      <div class="col-md-6">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('coupons/addcoupons') ?>" class="btn blue"> <i class="fa fa-plus"></i> ADD</a> </div>
            <div class="tools"></div>
          ...
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"  id="sample_4">
              ...
              <tbody>
              <?php if ($coupons): ?>
                  <?php foreach ($coupons as $ct): ?>
                <tr>
                 <td><?php echo $ct->brand_name ?> </td>
                  <td><?php echo $ct->title ?> </td>
                    <td><?php echo $ct->coupon_link?> </td>
                  <td><?php echo $ct->coupon_desc?> </td>
                 
                    <td><?php echo $ct->coupon_code?> </td>
                    
                  <td><?php echo $ct->added_date ?> </td>
                  <td> <a class="btn btn-success inactive" href="<?php echo site_url('coupons/status/'.$ct->coupon_id.'') ?>">
                        <?php if ( $ct->status==1): echo "Active" ;?>
                        <?php else: echo "Inactive "; ?>
                        <?php endif ?>
                    </a></td>
                  <td><a href="<?php echo site_url('coupons/edit/'.$ct->coupon_id.'') ?>"><i class="fa fa-pencil-square-o"></i><a class="delete"  href="<?php echo site_url('coupons/delete/'.$ct->coupon_id.'') ?>" > <i class="fa fa-trash"></i></a></td>
                </tr>
                  <?php endforeach ?>
                  <?php else: ?>
                  <tr>
