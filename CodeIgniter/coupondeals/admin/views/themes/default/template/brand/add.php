        ...
        <div class="col-md-12">
          ...
          <div class="portlet light portlet-fit portlet-form ">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Add  Brand</span> </div>
            ...
            echo form_open_multipart('brands/add', $attributes);  ?>
              ...
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="brand_link" id="brand_link">
                ...
                <div class="form-group form-md-checkboxes">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-checkbox">
                      ...
                      <input id="checkbox6" class="md-check" type="checkbox" value="1" name="feature" id="feature">
