      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet light portlet-fit portlet-form ">
            ...
            echo form_open_multipart('brands/updatebrand', $attributes);  ?>

              <div class="form-body">

                <input type="hidden" value="<?= $brands->brand_id ?>" name="brand_id">
                ...
                <!--<div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea name="short_desc" id="short_desc" cols="60" rows="5"><?= $brands->short_desc ?>
                ...
                <?php  $uploadsee_path =  $this->config->item('show_upload_path').'/brandsimages/';?>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                      ...
                      <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 520px; height: 170px;"><img src="<?= $uploadsee_path.$brands->img_name;?>"> </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="brand_link" id="brand_link" value="<?= $brands->brand_link ?>">
                ...
                <div class="form-group form-md-checkboxes">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-checkbox">
                      ...
                      <input id="checkbox6" class="md-check" type="checkbox"  name="feature" id="feature" <?= $brands->feature == 1 ? 'checked': '' ?> value="1">
