...
<head>
<meta charset="utf-8" />
<title>Savetakatak| Brands</title>
      ...
      <div class="col-md-6">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('brands/addbrands') ?>" class="btn blue"> <i class="fa fa-plus"></i> ADD</a> </div>
            <div class="tools"></div>
          ...
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" >
              ...
              <tbody>
              <?php if ($brands): ?>
                  <?php foreach ($brands as $ct): ?>
                <tr>
                 <td><?php echo $ct->brand_name ?> </td>
                  <td><?php echo $ct->added_date ?> </td>
                  <td><a href="<?php echo site_url('brands/edit/'.$ct->brand_id.'') ?>"><i class="fa fa-pencil-square-o"></i><a class="delete"  href="<?php echo site_url('brands/delete/'.$ct->brand_id.'') ?>" > <i class="fa fa-trash"></i></a></td>
                </tr>
                  <?php endforeach ?>
                  <?php else: ?>
                  <tr>
