      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            ...
            echo form_open_multipart('blogcategories/updatecat', $attributes);  ?>
                <div class="form-body">
                <input type="hidden" value="<?= $blogcategories->blog_cat_id ?>" name="blog_cat_id">
                  <div class="form-group">
                    <label class="control-label col-md-3">Name <span class="required"> * </span> </label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="blog_cat_name" id="blog_cat_name" value="<?= $blogcategories->blog_cat_name ?>">
                    </div>
                  </div>
                  </div>
