        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Add  Banners</span> </div>
            </div>
            ...
            echo form_open_multipart('banners/add', $attributes);  ?>
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <textarea name="script_desc" id="summernote_1" cols="60" rows="5"></textarea>
                  </div>
                </div>
                <div class="form-group ">
