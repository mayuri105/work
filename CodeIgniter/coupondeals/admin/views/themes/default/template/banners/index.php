      ...
      <div class="col-md-6">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('banners/addBanners') ?>" class="btn blue"> <i class="fa fa-plus"></i> ADD</a> </div>
            <div class="tools"></div>
              ...
              <?php if ($banners): ?>
                ...
                <tr>
                 <td><?php echo $ct->name ?> </td>
                  ...
                  <td><a class="btn btn-success inactive" href="<?php echo site_url('banners/status/'.$ct->banner_id.'') ?>">
                        <?php if ( $ct->status==1): echo "Active" ;?>
                        <?php else: echo "Disable"; ?>
                        <?php endif ?>
                    </a></td>
                  <td><a href="<?php echo site_url('banners/edit/'.$ct->banner_id.'') ?>"><i class="fa fa-pencil-square-o"></i><a class="delete"  href="<?php echo site_url('banners/delete/'.$ct->banner_id.'') ?>" > <i class="fa fa-trash"></i></a></td>
                </tr>
                  <?php endforeach ?>
                  <?php else: ?>
                  <tr>
