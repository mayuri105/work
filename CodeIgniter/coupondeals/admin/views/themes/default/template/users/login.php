...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Savetakatak | Admin Login</title>
        ...
        <link href="<?= site_url('views/themes/default') ?>/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="">
                <img src="<?= site_url('views/themes/default') ?>/assets/images/logo.png" alt="" /> </a>
        </div>
       <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <?php 
      ...
      <?php } ?>
        ...
        <div class="copyright"> 2016 © Savetakatak Admin </div>
        ...
        <script src="<?= site_url('views/themes/default') ?>/assets/pages/scripts/login.min.js" type="text/javascript"></script>
