      ...
      <div class="col-md-12">
        <div class="portlet box green">
          <div class="portlet-title">
            <div class="caption"> <a href="<?= site_url('admin/addadmin') ?>" class="btn blue"> ADD Admin <i class="fa fa-plus"></i> </a> </div>
            <div class="tools"></div>
          </div>
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
              ...
              <tbody>
               <?php if ($admins): ?>
                  <?php foreach ($admins as $ct): ?>
                <tr>
                  <td><?php  echo $ct->username?> </td>
                  <td><?php  echo $ct->email?>  </td>
                  <td><?php  echo $ct->added_date?> </td>
                
                  <td><a class="delete"  href="<?php echo site_url('admin/delete/'.$ct->id.'') ?>" >  <i class="fa fa-trash"></i></a></td>
                </tr>
