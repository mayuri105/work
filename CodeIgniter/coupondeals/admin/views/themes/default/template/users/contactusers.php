        ...
        <div class="portlet box green">
          ...
          <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
                ...
                <tr>
                  ...
                  <th class="none">Phone</th>
                   <th class="none">Company</th>
                    <th class="none">Enquiry type</th>
                     <th class="none">Country</th>
                   <th class="none">Industry</th>
              ...
              <tbody>
               <?php if ($userscontact): ?>
                  <?php foreach ($userscontact as $ct): ?>
                <tr>
                  <td><?php  echo $ct->fname?>&nbsp;<?php  echo $ct->lname?> </td>
                  <td><?php  echo $ct->email?></td>
                  <td><?php  echo $ct->phone?></td>
                  <td><?php  echo $ct->cname?></td>
                  <td><?php  echo $ct->enquiry_type?></td>
                  <td><?php  echo $ct->country?></td>
                  <td><?php  echo $ct->industry?></td>
                  <td><?php  echo $ct->message?></td>
                 
                  <td><?php  echo $ct->added_date?></td>
                 
                  <td><a class="delete"  href="<?php echo site_url('users/deletecontact/'.$ct->contact_id.'') ?>" >  <i class="fa fa-trash"></i></a></td>
                </tr>
                <?php endforeach ?>
                  <?php else: ?>
                  <tr>
                    <td colspan="3">No Conatct found</td>
                  </tr>
                  <?php endif ?>
