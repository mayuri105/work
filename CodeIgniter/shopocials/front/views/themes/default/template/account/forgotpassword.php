        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                    <form action="<?= site_url('account/setforgotpassword') ?>" method="post" name="customer_login" class="theme-form">
                    ...
                    <?php } ?>
                       ...
                       <button type="submit" class="btn btn-solid" tabindex="">Forgot Password</button>
                    </form>
                </div>
            </div>
        </div>
