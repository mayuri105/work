        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                  ...
                  <form action="<?= site_url('account/add_seller') ?>" method="post" name="seller_register" class="theme-form">
                    ...
                    <?php } ?>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="fname" placeholder="First Name" name="first_name" value="<?php echo set_value('first_name'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="input">Last Name</label>
                                <input type="text" class="form-control" id="lname" placeholder="Last Name" name="last_name" value="<?php echo set_value('last_name'); ?>">
                            </div>
                        </div>
						<div class="form-row">
                            <div class="col-md-12">
                            <label for="input">Business Name</label>
                            <input type="text" class="form-control" id="bname" placeholder="Business Name" name="business_name" value="<?php echo set_value('business_name'); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="input">Phone Number</label>
                                <input type="text" class="form-control" id="phone" placeholder="Phone Number" name="phone_number" value="<?php echo set_value('phone_number'); ?>">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <input type="password" class="form-control" id="pass" placeholder="Enter your password" name="password" value="<?php echo set_value('password'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="input">Confirm Password</label>
                                <input type="password" class="form-control" id="cpass" placeholder="Enter your password" name="cpassword" value="<?php echo set_value('cpassword'); ?>">
                            </div>
                        </div>
                            <button type="submit" class="btn btn-solid" tabindex="">Create Account</button>
...
<div class="fb-customerchat"
     ...
     theme_color="#0084ff"
     logged_in_greeting="Hi! Welcome to Shopocial How can we help you?"
     logged_out_greeting="Hi! Welcome to Shopocial How can we help you?">
</div>
