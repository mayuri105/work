        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                    <form action="<?= site_url('account/saveprofile') ?>" method="post" name="customer_profile" class="theme-form">
                    ...
                    <?php } ?>
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="fname" placeholder="First Name" name="first_name" value="<?php echo $customerinfo->first_name;?>">
                            </div>
                            <div class="col-md-6">
                                <label for="review">Last Name</label>
                                <input type="text" class="form-control" id="lname" placeholder="Last Name" name="last_name" value="<?php echo $customerinfo->last_name;?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="email">email</label>
                                <input type="text" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $customerinfo->email;?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="input">Phone Number</label>
                                <input type="text" class="form-control" id="phone" placeholder="Phone Number" name="phone_number" value="<?php echo $customerinfo->phone;?>" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4">
                                <label for="review">Old Password</label>
                                <input type="password" class="form-control" id="opass" placeholder="Enter your password" name="oldpassword">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="address" placeholder="Address" name="address" value="<?php echo $customerinfo->address;?>">
                            </div>
                        </div>
