...
<section class="about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="front/views/themes/default/img/images/about/about us.jpg" class="img-fluid" alt=""></div>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="slide-2 testimonial-slider no-arrow">
                    <div>
                        <div class="media">
                            <div class="text-center">
                                <img src="/front/views/themes/default/img/images/avtar.jpg" alt="#">
                                <h5>Mark Jecno</h5>
                                <h6>Designer</h6>
                            </div>
                    ...
                    <div>
                        <div class="media">
                            <div class="text-center">
                                <img src="/front/views/themes/default/img/images/2.jpg" alt="#">
                                <h5>Mark Jecno</h5>
                                <h6>Designer</h6>
                            </div>
                            <div class="media-body">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="team-4">
                    <div>
                        <img src="/front/views/themes/default/img/images/team/1.jpg" class="img-fluid" alt="">
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
                        <img src="/front/views/themes/default/img/images/team/2.jpg" class="img-fluid" alt="">
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
                        <img src="/front/views/themes/default/img/images/team/3.jpg" class="img-fluid" alt="">
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
                        <img src="/front/views/themes/default/img/images/team/4.jpg" class="img-fluid" alt="">
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
