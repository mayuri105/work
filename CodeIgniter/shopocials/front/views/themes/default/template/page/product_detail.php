...
<!--Start  Details Page Section Start  -->
<!-- breadcrumb start -->
                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="#"><img class="img-fluid" src="/front/views/themes/default/img/images/pro/1.jpg" alt=""></a>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="product-slick">
                                    <div><img src="/front/views/themes/default/img/images/pro3/1.jpg" alt="" class="img-fluid image_zoom_cls-0"></div>
                                    <div><img src="/front/views/themes/default/img/images/pro3/2.jpg" alt="" class="img-fluid image_zoom_cls-1"></div>
                                    <div><img src="/front/views/themes/default/img/images/pro3/1.jpg" alt="" class="img-fluid image_zoom_cls-2"></div>
                                    <div><img src="/front/views/themes/default/img/images/pro3/2.jpg" alt="" class="img-fluid image_zoom_cls-3"></div>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <div><img src="/front/views/themes/default/img/images/pro3/1.jpg" alt="" class="img-fluid"></div>
                                            <div><img src="/front/views/themes/default/img/images/pro3/2.jpg" alt="" class="img-fluid"></div>
                                            <div><img src="/front/views/themes/default/img/images/pro3/1.jpg" alt="" class="img-fluid"></div>
                                            <div><img src="/front/views/themes/default/img/images/pro3/2.jpg" alt="" class="img-fluid"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 rtl-text">
                                <div class="product-right">
                                        ...
                                        <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body"><img src="/front/views/themes/default/img/images/size-chart.jpg" alt="" class="img-fluid"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="size-box">
                                    ...
                                    <div class="product-buttons"><a href="#" class="btn btn-solid">add to cart</a> <a href="#" class="btn btn-solid">buy now</a></div>
...
<!--End  Details Page Section Start  -->
