...
<!-- Home slider -->
<?php echo Modules::run('header/header/slider'); ?>
<!-- Home slider end -->
...
<section class="pb-0">
    <div class="container">
        <div class="row partition2">
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center"> <img src="front/views/themes/default/img/images/sub-banner1.jpg" class="img-fluid" alt="">
            ...
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center"> <img src="front/views/themes/default/img/images/sub-banner2.jpg" class="img-fluid" alt="">
                        <div class="contain-banner">
                            <div>
                                <h4>save 60%</h4>
                                <h2>women</h2></div>
...
<div class="title1 section-t-space">
    <h4>special offer</h4>
    <h2 class="title-inner1">top collection</h2></div>
<div class="container">
    <div class="row">
                ...
                <div class="product-4 product-m no-arrow">
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/1.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/2.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                        </div>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on sale</span></div>
                            <div class="front">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/33.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/34.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                        </div>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/35.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="front/views/themes/default/img/images/pro3/36.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                        </div>
...
<div class="title1 section-t-space">
    ...
    <h2 class="title-inner1">special products</h2></div>
<section class="section-b-space p-t-0">
    <div class="container">
        <div class="row">
            <div class="col">
                        ...
                        <div id="tab-5" class="tab-content">
                            <div class="no-slider row">
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="#"><img src="front/views/themes/default/img/images/pro3/27.jpg" class="img-fluid" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="#"><img src="front/views/themes/default/img/images/pro3/28.jpg" class="img-fluid" alt=""></a>
                                        </div>
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="title1 section-t-space">
                <h4>Recent Story</h4>
                <h2 class="title-inner1">from the blog</h2></div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="slide-3 no-arrow">
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect"><img src="front/views/themes/default/img/images/blog/1.jpg" class="img-fluid" alt=""> <span></span></div>
                        </a>
                        <div class="blog-details">
                            ...
                            <hr class="style1">
                            <h6>by: John Dio , 2 Comment</h6></div>
                    </div>
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect"><img src="front/views/themes/default/img/images/blog/2.jpg" class="img-fluid" alt=""> <span></span></div>
                        </a>
                        <div class="blog-details">
                            <h4>25 January 2018</h4>
                            <a href="#">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect"><img src="front/views/themes/default/img/images/blog/3.jpg" class="img-fluid" alt=""> <span></span></div>
                        </a>
                        <div class="blog-details">
                            <h4>25 January 2018</h4>
                            <a href="#">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect"><img src="front/views/themes/default/img/images/blog/4.jpg" class="img-fluid" alt=""> <span></span></div>
                        </a>
                        <div class="blog-details">
                            <h4>25 January 2018</h4>
                            <a href="#">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect"><img src="front/views/themes/default/img/images/blog/5.jpg" class="img-fluid" alt=""> <span></span></div>
                        </a>
                        <div class="blog-details">
                            <h4>25 January 2018</h4>
                            <a href="#">
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                ...
                <div class="slide-7 no-arrow slick-instagram">
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/2.jpg" alt="Avatar" style="width:100%">
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/3.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/4.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/9.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/6.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/7.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="#">
                            <div class="instagram-box"> <img src="front/views/themes/default/img/images/slider/8.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                            </div>
                        </a>
                    </div>
