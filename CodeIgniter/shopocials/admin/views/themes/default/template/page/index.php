       ...
       <div id="page-content">
        ...
        <div class="block">
          <div class="well">
            <div class="row">
              <div class="col-sm-12">
                <a  href="<?php echo site_url('page/add'); ?>"  class="btn btn-primary pull-left"><i class="fa fa-plus"></i> Add Page</a>
              </div>
            </div>
          </div>      
             ...
             <tr>
              ...
              <td class="text-center">
                <div class="btn-group btn-group-xs">
                  <a href="<?php echo site_url('page/edit/'.$page->p_id.'') ?>" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>

                  <a data-toggle="tooltip" title="Delete" class="btn btn-danger delete"  href="<?php echo site_url('page/pagedelete/'.$page->p_id.'') ?>" > <i class="fa fa-times"></i></a></td>
                </tr>
              </tr>
