<!DOCTYPE html>
 <html class="no-js" lang="en">
    <head>
        ...
        <title>Make brand Package Add</title>
        ...
        <div id="page-wrapper">
            ...
            <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
				...
				<?php echo Modules::run('messages/message/index'); ?>
				 <div class="col-md-12">
							<?php 
                   $attributes = array('class' => 'form-horizontal', 'id' => 'pakages');

                   echo form_open_multipart('packages/addpackage', $attributes);  ?>
								
								 <div class="col-md-8">
									<label class="control-label">Name</label>
									
										<input type="text" name="package_name" value="<?= set_value('package_name') ?>" class="form-control">
									</div>
								...
								<input type="text" name="package_price" value="<?= set_value('package_price') ?>" class="form-control">
								 ...
								 <div class="col-md-8">
									...
									<input type="text" name="package_periods" value="<?= set_value('package_periods') ?>" class="form-control">
