                ...
                <div class="block">
                    <div class="panel panel-inverse">
                        <div class="panel-body">
                           ...
                           echo form_open_multipart('pages/update', $attributes);  ?>
                    ...
                    <div class="col-md-8">
                       <label class="control-label">Show on Footer</label>
                       <?php if ($page->show_on_footer): ?>
                         <input type="checkbox" id="" name="show_on_footer" value="1" checked >
                         <?php else: ?>
