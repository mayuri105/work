        ...
        <div class="block">
            <div class="panel panel-inverse">
                <div class="panel-body">
                 ...
                 echo form_open_multipart('banners/update', $attributes);  ?>
                 <input class="form-control" type="hidden" name="banner_id"  value="<?= $banner->banner_id; ?>">
                 <div class="col-md-8">
                   ...
                   <div class="fileinput fileinput-new" style="width: 100%;" data-provides="fileinput">
                     <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput" style="width: 100%; height: 150px;">
                         <?php if ($banner->banner_image): ?>
                            <img src="<?php echo getuploadpath().'banners/'.$banner->banner_image; ?>">
                        <?php endif ?>
                    </div>
                    <div>
