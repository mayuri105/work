...
<?php
	$attributes = array('class' => 'form-horizontal', 'id' => 'products');
	echo form_open_multipart('products/editchange', $attributes);  ?>
...
<div class="pb"></div>
        ...
        <div class="col-md-12">
    	  	 <br>
				 <br>
				 <input class="form-control" type="hidden" name="product_id" id="" value="<?= $product->product_id; ?>">
				 <input class="form-control" type="hidden" name="shop_id" id="" value="<?= $product->shop_id; ?>">
				...
				<label class="control-label">Product Description	</label>
					<textarea name="small_desc" rows="10" id="small_desc" class="form-control"><?php echo $product->small_desc ?></textarea>
				</div>
				<div class="col-md-4">
								...
								<img src="<?php echo getuploadpath().'product/'.$product->product_image; ?>">
							<?php endif ?>
									</div>
									<div>
				...
				<label class="control-label">Brand
					...
					<select class="form-control" name="brand_id">
						<?php foreach ($brands as $t): ?>
							<option value="<?php echo $t->brand_id ?>" <?php echo $t->brand_id == $product->brand_id ? 'selected' : '' ?>><?php echo $t->name ?></option>
						<?php endforeach ?>
					</select>
				</div>
				<div class="col-md-3">
				<label class="control-label">Category
					...
					<?php foreach ($categories as $c): ?>
							<option value="<?php echo $c->cat_id ?>" <?php echo $c->cat_id == $product->cat_id ? 'selected' : '' ?>><?php echo $c->category ?></option>
						<?php endforeach ?>
					</select>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-4">
			...
			<div class="col-md-4">
				<label class="control-label">Quantity</label>
					 <input type="number" name="qty" min="1"  value="<?php echo $product->qty ?>" class="form-control">
			</div>
				<div class="col-md-4">
				<br>
				<br>
				 <input type="checkbox" name="is_popular" value="1" <?php echo $product->is_popular ? 'checked' : '' ?>>
				<label class="control-label">Set Product As Home
				</label>
			</div>
		</div>
		</div>
			...
			<div id="images" class="span9">
                ...
                <div  >
                    ...
                    <table role="presentation" id="files" class="table table-striped">
                    	<tbody class="files">
                    		<?php foreach ($product_images as $proImage): ?>
                    		<tr>
                    				<td>
                    			<img src="<?php echo getuploadpath().'product/'.$proImage->image_name ?>" width="100" height="100">
                    			<br>
