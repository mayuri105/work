            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="srch_frm">
                        ...
                        echo form_open('investment-opportunities/search', $attributes);  ?>
                            ...
                            <div class="img_hov_eff">
                                ...
                                <?php if (is_login()): ?>
                                    <?php if (checkPackage('3')): ?>
                                            ...
                                            <a class="btn btn-default btn_trans" href="<?php echo site_url('investment-opportunities/property/'.$p->property_slug.'') ?>" class="btn btn btn-outlined btn-theme pull-right btn-large btn-caps">Read More</a>
                                    <?php else: ?>
                            ...
                            <div class="properties-actions">
                                 <?php if (is_login()): ?>
                                    <?php if (checkPackage('3')): ?>
                                            ...
                                            <a href="<?php echo site_url('investment-opportunities/property/'.$p->property_slug.'') ?>" class="btn btn btn-outlined btn-theme pull-right btn-large btn-caps">Read More</a>
                                    <?php else: ?>
    ...
    <!-- Subscribe Section -->
     ...
     <section id="testim">
            <div class="container">
                ...
                <div class="col-md-6 text-center">
                  <a href="<?php echo site_url('rent-sale') ?>"   class=" btn  btn-lg btn-danger">Rent/Sale </a>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container -->
