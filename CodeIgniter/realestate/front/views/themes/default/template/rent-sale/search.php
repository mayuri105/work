                            ...
                            <div class="control-group form-group col-md-11">
                                <div class="controls col-md-3 first">
                                    ...
                                    <select name="type" class="form-control"  >
                                        ...
                                        <?php foreach ($types as $t ): ?>
                                            <option value="<?php echo $t->cat_id ?>" <?php echo $t->cat_id== $type ?'selected' : '' ?>><?php echo $t->category ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="controls col-md-3">
                                    ...
                                    <select name="actions"  id="actions" class="form-control"  >
                                        <option value="" selected="selected">None</option>
                                        <option value="rent"  <?php echo $actions=='rent'  ? 'selected':'' ?>>For Rent</option>
                                        <option value="sale" <?php echo $actions=='sale'  ? 'selected':'' ?>>For Sale</option>
                                    </select>
                                </div>
                                <div class="controls col-md-3">
