...
<script src="<?= site_url('views/themes/default') ?>/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js"></script>
	...
	<script type="text/javascript">	
        ...
        $('#chart-sale').bind('plothover', function(event, pos, item) {
                ...
                if (item) {
                        $('<div id="tooltip" class="tooltip top in"><div class="tooltip-arrow"></div><div class="tooltip-inner">Rental:' + item.datapoint[1].toFixed(2) + '</div></div>').prependTo('body');
