	...
	<div class="static-content">
		<div class="page-content">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="">Subscription Reports</a></li>
			...
			<div class="container-fluid">
				...
				<div class="panel panel-inverse">
						<div class="panel-body ">
							<div class="">
								<form action="<?= site_url('reports/subscription') ?>" method="get" name="filter">
...
<script src="<?= site_url('views/themes/default') ?>/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js"></script>
	...
	<script type="text/javascript">	
        ...
        $('#chart-sale').bind('plothover', function(event, pos, item) {
                ...
                if (item) {
                        $('<div id="tooltip" class="tooltip top in"><div class="tooltip-arrow"></div><div class="tooltip-inner">Subscription :Rs' + item.datapoint[1].toFixed(2) + '</div></div>').prependTo('body');
