    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
				...
				<li class="active"><a href="">Add Package Category</a></li>
			...
			<div class="container-fluid">
				...
				<div class="panel panel-inverse">
					<div class="panel-body">
						...
						echo form_open_multipart('package_category/add', $attributes);  ?>
					   	    ...
					   	    <div class="tab-content">
						        <div class="tab-pane active" id="tab-general">
					        	  	<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="package_category_name" required="" id="package_category_name" value="" class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<input type="text" name="extend_days_for_same_package" required="" id="extend_days_for_same_package" value="" class="form-control">
										</div>
									</div>
								</div>
