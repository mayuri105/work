			...
			<div class="container-fluid">
				...
				<div class="panel panel-inverse">
					<div class="panel-body">
						...
						echo form_open_multipart('categories/add', $attributes);  ?>
					   	    ...
					   	    <div class="tab-content">
						        <div class="tab-pane active" id="tab-general">
					        	  	<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="categories_name" required="" id="categories_name" value="" class="form-control">
										</div>
									</div> 
										...
										<div class="col-sm-8">
											<select name="parent_category" class="form-control"  id="parent_category"  >
												...
												<?php foreach ($category_par as $l): ?>
													<option value="<?= $l->cat_id ?>"><?= $l->category ?></option>
												<?php endforeach ?>
											</select>
										</div>
									</div>
