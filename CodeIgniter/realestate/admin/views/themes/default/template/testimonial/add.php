			...
			<div class="container-fluid">
				...
				<div class="panel panel-inverse">
					<div class="panel-body">
						...
						echo form_open_multipart('testimonial/add', $attributes);  ?>
					   	    ...
					   	    <div class="tab-content">
						        <div class="tab-pane active" id="tab-general">
					        	  	<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="testimonial_name" required="" id="testimonial_name" value="" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Testimonial
											<span class="required">*</span></label>
											<div class="col-sm-8">
												<textarea  name="testimonial" required="" class="form-control"></textarea>
											</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">User Position
											<span class="required">*</span></label>
										<div class="col-sm-8">
											<input type="text" name="user_position" required="" id="user_position" value="" class="form-control">
										</div>
									</div>
