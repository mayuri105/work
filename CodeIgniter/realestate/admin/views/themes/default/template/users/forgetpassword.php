			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form action="<?php echo site_url('login/submitforget') ?>" method="post" class="form-horizontal" id="validate-form">
							...
							<div class="form-group mb-md">
		                        <div class="col-xs-12">
		                        	<div class="input-group">							
										...
										<input type="email" name="username" class="form-control" placeholder="<?= $this->lang->line('username'); ?>" data-parsley-minlength="6" placeholder="At least 6 characters" >
									</div>
		                        </div>
							</div>
