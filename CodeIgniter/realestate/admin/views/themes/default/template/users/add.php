								...
								<div>
										...
										<div class="modal-body"	>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" name="user_name" required id="user_name" value="<?= set_value('user_name') ?>"class="form-control">
												</div>
											</div>
											<div class=""></div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="password" id="password"  name="password" required value="<?= set_value('password') ?>" class="form-control">
												</div>
											</div>
											<div class=""></div> 
