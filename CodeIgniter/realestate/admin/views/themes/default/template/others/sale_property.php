	...
	<div class="static-content">
		<div class="page-content">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="">Sale A property </a></li>
			</ol> 
			<div class="container-fluid">
				<div class="pb-sm">
					<button id='delete' class="btn btn-danger pull-right ml"><i class="fa fa-trash"></i> Delete</button>
					<a href="<?= site_url('others/addsaleaproperty') ?>" class="btn btn-primary pull-right ml"><i class="fa fa-plus"></i> Add</a>
				</div>
				<div class="mt-xl"></div> 
				...
				<div class="panel panel-inverse">
						<div class="panel-body ">
							<div class="well">
								<div class="row">
									<form action="<?=  site_url('others/saleaproperty'); ?>" method="get" name="filter">
										<div class="col-sm-12">
							...
							<table class="table table-striped" id="aftersearch">
								...
								<tbody id="tbody">
									...
									<tr>
										<td><input type="checkbox" value="<?= $s->sale_property_id ?>" class="delete" name="delete[]"></td>
										<td><?php echo $s->property_title ?></td>
										<td><?php echo $s->first_name.' '.$s->last_name ?></td> 
										<td>Rs.<?php echo $s->amount ?></td>	 
										<td class="text-right"><a href="<?php echo site_url('others/editsaleaproperty/'.$s->sale_property_id.'') ?>" class="btn btn-primary">Edit</a>	</td>
									</tr>
									<?php endforeach ?>
									<?php else: ?>
									<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#delete').click(function(event){
			...
			alertify.confirm("Are you sure you want to Delete this Sale property  ?", function (result) {
			    if (result) {
					$.ajax({
						url :" <?= site_url('others/deletemultipleSalePro'); ?>",
						type: "post",
