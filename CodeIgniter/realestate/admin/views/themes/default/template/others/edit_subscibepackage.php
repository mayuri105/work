    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
				...
				<li class="active"><a href="">Edit Subscription Package</a></li>
			...
			<div class="container-fluid">
				...
				<div class="mt-xl"></div> 
				<h2>Edit Subscription Package</h2>
				<div class="panel panel-inverse">
					<div class="panel-body">
						<?php 
						$attributes = array('class' => 'form-horizontal', 'id' => 'appointment');

						echo form_open_multipart('others/updatesubpackageSubmit', $attributes);  ?>
						        ...
						        <div class="tab-pane active" id="tab-general">
										...
										<div class="col-sm-8">
											<select name="customer" id="customer" required> 
												...
												<?php foreach ($cust as $c): ?>
													<option value='<?php echo $c->c_id ?>' <?php echo $subpack->customer_id == $c->c_id ? 'selected' : '' ?>><?php echo $c->first_name.' '.$c->last_name ?></option>
												<?php endforeach ?>
											</select>
										</div>
									</div>
										...
										<div class="col-sm-8">
											<select name="package_name" id="package_name" class="form-control" required> 
												...
												<?php foreach ($package as $p): ?>
													<option value='<?php echo $p->package_id ?> ' <?php echo $subpack->package_name == $p->package_name ? 'selected' : '' ?>><?php echo $p->package_name ?></option>
												<?php endforeach ?>
											</select>
										</div>
										<input type="hidden" class="form-control" id="cp_id" name="cp_id" value="<?php echo $subpack->cp_id ?>" required>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Package price	
											<span class="required">*</span></label>
										<div class="col-sm-8">
											<input type="text" class="form-control" required id="package_price" name="package_price" disabled="disabled"  value="<?php echo $subpack->package_price ?>" >
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Package Start Date	
											<span class="required">*</span></label>
										<div class="col-sm-8">
											<input type="text" class="form-control " required id="package_start_date" name="package_start_date"  disabled="disabled"  value="<?php echo $subpack->package_start_date ?>" >
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<input type="text" class="form-control " required id="package_end_date" name="package_end_date"  disabled="disabled"  value="<?php echo $subpack->package_end_date ?>" >
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="payment_method" id="payment_method" class="form-control" required> 
												<option value=''>None</option>
												<option value='cash'  <?php echo $subpack->payment_method == 'cash' ? 'selected' : '' ?>  >Cash</option>
											</select>
										</div>
									</div>
