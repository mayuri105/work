<?php /* Smarty version 2.6.0, created on 2017-02-09 13:42:41
...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td align="left" valign="top"><form name="frmSiteConfig" action="<?php echo $this->_tpl_vars['A_Action']; ?>
                ...
                <tr>
                  <td valign="top"><table border="0" align="center" cellpadding="5" cellspacing="2" class="table-long" width="100%">
                      <tr>
                        ...
                        <td class="odd"><textarea name="site_title" rows="3" cols="50" class="textarea"><?php echo $this->_tpl_vars['site_title']; ?>
</textarea>
                          <br>
                      ...
                      <tr>
                        ...
                        <td class="odd"><textarea name="site_keyword" rows="4" cols="50" class="textarea"><?php echo $this->_tpl_vars['site_keyword']; ?>
</textarea>
                          <br>
                      ...
                      <tr>
                        ...
                        <td class="odd"><textarea name="site_description" rows="4" cols="50" class="textarea"><?php echo $this->_tpl_vars['site_description']; ?>
</textarea>
                          <br>
					  ...
					  <tr>
                        ...
                        <td class="odd"><input name="copyright_text" class="textbox" value="<?php echo $this->_tpl_vars['copyright_text']; ?>
">
                      </tr>
					  <tr>
                        <td align="right" valign="top" class="odd">Footer Text</td>
                        <td class="odd"><input name="footer_text" class="textbox" value="<?php echo $this->_tpl_vars['footer_text']; ?>
">
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
