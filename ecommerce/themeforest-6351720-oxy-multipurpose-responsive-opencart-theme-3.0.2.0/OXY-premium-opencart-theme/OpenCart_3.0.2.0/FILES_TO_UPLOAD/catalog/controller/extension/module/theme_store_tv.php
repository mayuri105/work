...
class ControllerExtensionModuleThemeStoreTV extends Controller {
	public function index($setting) {
		...
		$data['store_tv'] = $setting['store_tv'][$this->config->get('config_language_id')];
		...
		$data['lazy_load_placeholder'] = 'catalog/view/theme/' . $this->config->get('config_theme') . '/js/lazyload/loading_video.gif';
		...
		return $this->load->view('extension/module/theme_store_tv', $data);
