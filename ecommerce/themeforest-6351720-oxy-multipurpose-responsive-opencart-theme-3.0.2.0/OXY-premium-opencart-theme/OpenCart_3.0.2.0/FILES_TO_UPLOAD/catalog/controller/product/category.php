...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$data['t1o_category_subcategories_per_row'] = $this->config->get('t1o_category_subcategories_per_row');
			$data['t1o_category_subcategories_autoplay'] = $this->config->get('t1o_category_subcategories_autoplay');
			...
			foreach ($results as $result) {
				...
				if ($result['image']) {
					...
					$image = $this->model_tool_image->resize('no_image_transparent.png', $this->config->get('theme_' . $this->config->get('config_theme') . '_image_category_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_category_height'));
				}
