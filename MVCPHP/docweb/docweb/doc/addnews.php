...
include("classes/news.cls.php");
 if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){
	$apcls=new news($_REQUEST["id"]);
	$data=$apcls->getNewsInfo();
	$act="Edit";
}else{
	$act="Add";
}
?>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100">
                    	...
                    	<form class="contact2-page-form col-lg-8 col-sm-12 col-md-8 col-xs-12 no-pad contact-v2" id="OutletForm" name="OutletForm" method="post" action="addnews_a.php" enctype="multipart/form-data" onSubmit="return addnews();">
                ...
                <p><span style="color:#FF6699;" id="ntitle_err"></span></p>
                       <p><textarea class="contact2-textarea" placeholder="Description*" name="txtDesc" id="txtDesc"><?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["description"];  } ?></textarea>
                           </p>
                           <p><span style="color:#FF6699;" id="ndesc_err"></span></p>
                           <p>
