...
<body>
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Outlet</h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.php">Home</a></li>
                <li><a href="addoutlet.php">Outlet</a></li>
                <li><a href="showOutlet.php">Show Add Outlet</a></li>
                </ul>
                </div>
            </div>
         </div>
...
include("classes/outlet.cls.php");
 if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){
	$apcls=new outlet($_REQUEST["id"]);
	$data=$apcls->getOutletInfo();
	$act="Edit";
}else{
	$act="Add";
}
?>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100">
                    	...
                    	<form class="contact2-page-form col-lg-8 col-sm-12 col-md-8 col-xs-12 no-pad contact-v2" id="OutletForm" name="OutletForm" method="post" action="addoutlet_a.php" enctype="multipart/form-data" onSubmit="return addoutlet();">
                        <input type="hidden" name="act" value="<?php echo $act; ?>" />
						<input type="hidden" name="id" value="<?php echo $_REQUEST["id"]; ?>" >
                       <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                       <p><input type="text" class="contact2-textbox" name="txtTitle" id="txtTitle" placeholder="Title*"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["title"];  } ?>"></p>
                 <p><span style="color:#FF6699;" id="otitle_err"></span></p>
                        <p>
                            	<textarea class="contact2-textarea" placeholder="Description*" name="txtdesc" id="txtOAddress"><?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["description"];  } ?></textarea>
                           </p>
                            <p><span style="color:#FF6699;" id="oaddress_err"></span></p>
                           <p>
                           Image:<input type="file" name="FileImg"> <?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["image"];  } ?>
                           </p>
                      <p><input type="text" class="contact2-textbox" name="txtLocation" id="txtLocation" placeholder="Location*"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["location"];  } ?>"></p>
                       <p><span style="color:#FF6699;" id="olocation_err"></span></p>
