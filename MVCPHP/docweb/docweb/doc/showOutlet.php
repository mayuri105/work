...
<body>
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Show Outlet</h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.php">Home</a></li>
                <li><a href="addoutlet.php">Add Outlet</a></li>
                <li><a href="showOutlet.php">Show Outlet</a></li>
                </ul>
                </div>
            </div>
         </div>
...
$data=$apcls->getOutletData();

if(isset($_REQUEST["Delete"])){

	  if(isset($_REQUEST["chkOut"])){
	
			$del=$apcls->deleteOutlet($_REQUEST["chkOut"]);
			
				echo "<script>alert('Outlet Delete')</script>";
                 ...
                 <?php if($data){ ?>
                  ...
                  <?php
                    ...
                    <td><input type="checkbox" name="chkOut" value="<?php echo $data[$j]["id"]; ?>" ></td>
                      ...
                      <td><?php echo $data[$j]["image"];?></td>
                      <td><?php echo $data[$j]["location"];?></td>
                      
                      <td><a  href="addoutlet.php?action=Edit&id=<?php echo $data[$j]["id"]; ?>" >Edit</a></td>
                    </tr>
