...
<body>
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Show News</h1></div>
...
$data=$apcls->getNewsData();

if(isset($_REQUEST["Delete"])){

	  if(isset($_REQUEST["chkOut"])){
	
			$del=$apcls->deleteNews($_REQUEST["chkOut"]);
			
				echo "<script>alert('News Delete')</script>";
                 ...
                 <?php if($data){ ?>
                  ...
                  <?php
                    ...
                    <td><input type="checkbox" name="chkOut" value="<?php echo $data[$j]["id"]; ?>" ></td>
                      ...
                      <td><a  href="addnews.php?action=Edit&id=<?php echo $data[$j]["id"]; ?>" >Edit</a></td>
                    </tr>
