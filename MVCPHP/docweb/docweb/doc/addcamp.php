...
?>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100">
                    	...
                    	<form class="contact2-page-form col-lg-8 col-sm-12 col-md-8 col-xs-12 no-pad contact-v2" id="OutletForm" name="OutletForm" method="post" action="addcamp_a.php" enctype="multipart/form-data" onSubmit="return addcamp();">
                        <input type="hidden" name="act" value="<?php echo $act; ?>" />
						<input type="hidden" name="id" value="<?php echo $_REQUEST["id"]; ?>" >
                       <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                       <p><input type="text" class="contact2-textbox" name="txtSubject" id="txtSubject" placeholder="Subject*"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["subject"];  } ?>">
                       </p>
                
                        <p><span style="color:#FF6699;" id="csubj_err"></span></p>
                           <p>
                           <textarea class="contact2-textarea" placeholder="Description*" name="txtDesc" id="txtDesc"><?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["description"];  } ?></textarea>
                           </p>
                            <p><span style="color:#FF6699;" id="caddress_err"></span></p>
                           <P>
                           <textarea class="contact2-textarea" placeholder="Location*" name="txtLocation" id="txtLocation" ><?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["location"];  } ?></textarea>
                           </P>
                            <p><span style="color:#FF6699;" id="clocation_err"></span></p>
                      <p> Date:<input type="text" class="contact2-textbox" style="width:90px;" placeholder="Start*" name="txtSdate" id="txtSdate"  size="2"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["start_date"];  } ?>">
                      <input type="text" class="contact2-textbox"  style="width:90px;" placeholder="End*" name="txtEdate" id="txtEdate"  size="10"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["end_date"];  } ?>">
                      </p>
                       <p><span style="color:#FF6699;" id="cstdate_err"></span>&nbsp;<span style="color:#FF6699;" id="ceddate_err"></span></p>
                      <p><input type="text" class="contact2-textbox" name="txtTime" id="txtTime" placeholder="Time*"  value="<?php if(isset($_REQUEST["action"]) && $_REQUEST["action"]=="Edit"){ echo $data["ctime"];  } ?>"></p>
                         <span style="color:#FF6699;" id="ctime_err"></span>  
