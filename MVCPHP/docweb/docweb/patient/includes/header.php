...
<header>
    ...
    <div id="search" class="fa fa-search search-head"></div>
            ...
            <form>
            	<P> <input name="LoginType" type="radio" value="1" />Doctor &nbsp; &nbsp;<input name="LoginType" type="radio" value="2" />Patient</P>
            	<P><span class="title">Username</span> <input name="" type="text" /></P>
                <P><span class="title">Password</span> <input name="" type="password" /></P>
                <P><input name="" type="button" value="SignIn" /></P>
            </form>
        </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown"><a href="appo.php" ><i class="icon-cog"></i>Appointment<b class="icon-angle-down"></b></a>
                             <ul class="dropdown-menu">
                                	<li class="dropdown"><a href="showappo.php">Show Booked Appintment</a>
                            ...
                            <li class="dropdown"><a href="addreviewd.php" ><i class="icon-file"></i>Add Review<b class="icon-angle-down"></b></a>
                                <!--<ul class="dropdown-menu">
