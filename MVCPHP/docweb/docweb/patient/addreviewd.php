...
?>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100">
                    	...
                    	<form class="contact2-page-form col-lg-8 col-sm-12 col-md-8 col-xs-12 no-pad contact-v2" id="ReviewForm" name="ReviewForm" method="post"  enctype="multipart/form-data" onSubmit="return addreview();">
                            ...
                            <p>
                            <select name="lblDoc" id="lblDoc" placeholder="Doctor*" style="width:340px; height:45px;" >
				 ...
				 $doctor = new registerClass;
			  	...
			  	?>
				    ...
				    <option value="<?=$alldoctor['docid'];?>" ><?=$alldoctor['name'];?></option>
			  ...
			  <?php
				  ...
				  ?>
                            ...
                            <span style="color:#FF6699;" id="sdoc_err"></span></p>
                             
                             <p>
                           <input type="text" placeholder="Name*" class="contact2-textbox" name="txtName" id="txtName" >
                           <span style="color:#FF6699;" id="name_err"></span></p>
                           <p>
                             <p>
                           <input type="text" placeholder="Subject*" class="contact2-textbox" name="txtSubject" id="txtSubject" >
                           <span style="color:#FF6699;" id="sub_err"></span></p>
                           <p>
                            	<textarea class="contact2-textarea" placeholder="Comment*" name="txtComment" id="txtComment"></textarea>
                          <span style="color:#FF6699;" id="com_err"></span></p>
                            <section class="color-7" id="btn-click">
                <p  data-loading-text="Loading..." ><input type="submit" name="btnSubmit" value="Submit"></p>
