...
?>
            <div class="table-elements" >
				<form name="showappo" id="showappo" method="post" style="width: 1000px;">
                ...
                <table class="table table-bordered table-striped table-responsive">
                 <?php if($appodata){ ?>
                  ...
                  <?php
                    ...
                    <tr>
                    <td><input type="checkbox" name="chkappo" value="<?php echo $appodata[$j]["apid"]; ?>" ></td>
                      ...
                      <td><?php if($appodata[$j]["status"]== 0){ echo "Pandding"; }if($appodata[$j]["status"]== 1){echo "Confirm"; }?></td>
                      <td><a  href="appo.php?action=Edit&apid=<?php echo $appodata[$j]["apid"]; ?>" >Edit</a></td>
                    </tr>
