...
require_once('inc/professorClass.php');
		...
		<link rel="shortcut icon" href="favicon.ico" />
				...
				function status(id,status)
			{
				...
				if(r==true)		
				{
					...
					window.location.href='change_status.php?professorId='+id+'&status='+status;
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allProfessor=$professorClass->fetchProfessorRegisteredDetails();
													$s=1;
													foreach($allProfessor as $prof)
													{	
												 ?>
												<tr>
													<td><?=$s;?></td>
													<td><a href="javascript:void(0);"  onClick="javascript:status('<?php echo $prof['userId']?>','<?php echo $prof['professor_status']?>');"><?php if($prof['professor_status']=='0'){ echo "Active"; } else { echo "Deactivate"; } ?></a></td>
													<td><?=$prof['professor_first_name'];?></td>
													<td><?=$prof['professor_last_name'];?></td>
													<td><?=$prof['professor_password'];?></td>
													<td><?=$prof['professor_email'];?></td>
													<td><?php if($prof['professor_profile_photo']!="") { ?><img src="../admin/../upload/professor_profile_pic/<?=$prof['professor_profile_photo'];?>" width="70" height="80" /><?php } else { ?><img src="../admin/../images/no-image.png" width="70" height="80" /> <?php } ?></td>
													<td>
													
													<a data-original-title="View" class="btn btn-xs btn-teal tooltips" href="#panel-config<?php echo $prof['userId']?>" data-toggle="modal"> <i class="fa fa-list"></i> </a>
													
													<div class="modal fade" id="panel-config<?php echo $prof['userId']?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Details of <strong><?=$prof['professor_first_name'];?> <?=$prof['professor_last_name'];?></strong></h4>
							</div>
							<div class="modal-body">
							
							
								<table><tr><td><?php echo $prof['professor_first_name']; ?></td></tr></table>
