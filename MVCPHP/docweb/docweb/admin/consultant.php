...
require_once('inc/studentClass.php');
		...
		<link rel="shortcut icon" href="favicon.ico" />
				...
				function status(id,status)
			{
				...
				if(r==true)		
				{
					...
					window.location.href='change_status.php?studentId='+id+'&status='+status;
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allStudent=$studentClass->fetchStudentRegisteredDetails();
													$s=1;
												...
												<tr>
													<td><?=$s;?></td>
													<td><a href="javascript:void(0);"  onClick="javascript:status('<?php echo $stud['userId']?>','<?php echo $stud['student_status']?>');"><?php if($stud['student_status']=='0'){ echo "Active"; } else { echo "Deactivate"; } ?></a></td>
													<td><?=$stud['student_first_name'];?></td>
													<td><?=$stud['student_last_name'];?></td>
													<td><?=$stud['student_password'];?></td>
													<td><?=$stud['student_email'];?></td>
													<td><?php if($stud['student_profile_photo']!="") { ?><img src="../admin/../upload/student_profile_pic/<?=$stud['student_profile_photo'];?>" width="70" height="80" /><?php } else { ?><img src="../admin/../images/no-image.png" width="70" height="80" /> <?php } ?></td>
													<td>
													
													<a data-original-title="View" class="btn btn-xs btn-teal tooltips" href="#panel-config<?php echo $stud['userId']?>" data-toggle="modal"> <i class="fa fa-list"></i> </a>
													
													<div class="modal fade" id="panel-config<?php echo $stud['userId']?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Details of <strong><?=$stud['student_first_name'];?> <?=$stud['student_last_name'];?></strong></h4>
							</div>
							<div class="modal-body">
							
							
								<table><tr><td><?php echo $stud['student_first_name']; ?></td></tr></table>
