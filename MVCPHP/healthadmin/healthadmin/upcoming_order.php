									...
									<div class="table-responsive">
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
			$cdate=date('Y-n-d');								
			$sql="select db_neworder_status.*,db_product_type.pname as product_name,db_sales_register.fname as sales_name,db_shop_register.shop_name from db_neworder_status,db_product_type,db_sales_register,db_shop_register where db_neworder_status.producttype_id = db_product_type.id and db_neworder_status.sales_id= db_sales_register.id and db_neworder_status.shop_id= db_shop_register.id and db_neworder_status.date >= '".$cdate."'";	
