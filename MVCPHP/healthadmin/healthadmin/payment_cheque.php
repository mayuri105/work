...
$SITE_PATH="http://mdollarideas.com/health_higeni_webservice/upload/";
...
<head>
		<title>Admin |Payment Cheque</title>
		<!-- start: META -->
		<meta charset="utf-8" />
				...
				<div class="container">
					...
					<div class="row">
						...
						<ol class="breadcrumb">
								...
								<li class="active">
									 <a href="shop_display.php"> Payment Cheque Detail </a>
								</li>
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allcheque=$adminClass->paychequehdetail();
													$s=1;
													foreach($allcheque as $allcheque)
													{	
												 ?>
												<tr>
													<td><?=$s;?></td>
													<td><?=$allcheque['fname'];?> </td>
													<td><?=$allcheque['shop_name'];?></td>
                                                    <td><?=$allcheque['total'];?></td>
                                                    <td><?=$allcheque['ammount'];?></td>
                                                     <td><?=$allcheque['date'];?></td>
                                                     <td><img src="<?=$SITE_PATH.$allcheque['cheque_img'];?>" alt="No Image" height="50" width="50"></td>
                                                    <td><?=$allcheque['added_date'];?></td>
                                                   
													
													<td>
													<a data-original-title="Remove" data-placement="top" class="btn btn-xs btn-bricky tooltips"  href="delete.php?chequeId=<?=$allcheque['id'];?>" ><i class="fa fa-times fa fa-white"></i></a>
													</td>									
