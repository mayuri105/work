...
public function addTarget($post)
	...
	public function targetdetail()
	{
		...
		// $query="SELECT db_target.*,db_sales_register.fname from db_target,db_sales_register where  db_target.sales_id=db_sales_register.id and target_type= 'daily'";
		   $query="select  db_target.*,db_sales_register.fname from db_target,db_sales_register where target_type='daily' and db_target.sales_id=db_sales_register.id";
		$result=mysql_query($query);
	...
	public function targetwdetail()
	{
		...
		//$date=date('Y-m-d');
		 $query="select  db_target.*,db_sales_register.fname from db_target,db_sales_register where target_type='weekly' and db_target.sales_id=db_sales_register.id";
	...
	public function targetmdetail()
	{
		...
		//$date=date('Y-m-d');
		 ...
		 $query="select  db_target_my.*,db_sales_register.fname from db_target_my,db_sales_register where db_target_my.target_type='monthly' and db_target_my.sales_id=db_sales_register.id";
		$result=mysql_query($query);
	...
	public function targetydetail()
	{
		...
		//$date=date('Y-m-d');
		 ...
		 $query="select  db_target_my.*,db_sales_register.fname from db_target_my,db_sales_register where db_target_my.target_type='yearly' and db_target_my.sales_id=db_sales_register.id";
		$result=mysql_query($query);
	...
	public function targetdetailall()
	{
		 
		//$date=date('Y-m-d');
		// $query="SELECT db_target.*,db_sales_register.fname from db_target,db_sales_register where  db_target.sales_id=db_sales_register.id and target_type= 'daily'";
		 $query="select db_target.*,db_sales_register.fname 
			from db_target,db_sales_register
			where   db_target.sales_id=db_sales_register.id 
	...
	public function targetwdetailall()
	{
		 
		$date=date('Y-m-d');
		 $query="SELECT db_target.*,db_sales_register.fname from db_target,db_sales_register where  db_target.sales_id=db_sales_register.id and target_type= 'weekly' ";
	...
	public function targetmdetailall()
	{
		 
		$date=date('Y-m-d');
		 $query="SELECT db_target_my.*,db_sales_register.fname from db_target_my,db_sales_register where  db_target_my.sales_id=db_sales_register.id and db_target_my.target_type= 'monthly'";
	...
	public function targetydetailall()
	{
		 
		$date=date('Y-m-d');
		 $query="SELECT db_target_my.*,db_sales_register.fname from db_target_my,db_sales_register where  db_target_my.sales_id=db_sales_register.id and db_target_my.target_type= 'yearly' ";
	...
	{
	 	echo $query="select * from  db_target where id='".$id."'";
		$result=mysql_query($query);
	...
	public function TargetdetailmyById($id)
	{
	 	$query="select * from  db_target_my where id='".$id."'";
		$result=mysql_query($query);
	...
	if($_POST['target_type']=='daily'){
	 $query="update db_target set 
	                        sales_id='".$post['sales_name']."',
							qty='".$post['d_qty']."',
							incentive='".$post['d_incentive']."',
							start_date='".$post['assign_date']."'
							 where id='".$post['taId']."'";
							
		$result=mysql_query($query);
	}	
	if($_POST['target_type']=='weekly'){
	 $query="update db_target set 
	                        sales_id='".$post['sales_name']."',
							qty='".$post['w_qty']."',
							incentive='".$post['w_incentive']."',
							start_date='".$post['sweek']."',
							end_date='".$post['eweek']."',
							 where id='".$post['taId']."'";
							
		$result=mysql_query($query);
	}	  
	if($_POST['target_type']=='monthly'){
	 $query="update db_target_my set 
	                        sales_id='".$post['sales_name']."',
							qty='".$post['m_qty']."',
							incentive='".$post['m_incentive']."',
							month='".$post['smonth']."',
							year='".$post['emonth']."',
							 where id='".$post['taId']."'";
	...
	if($_POST['target_type']=='yearly'){
	 $query="update db_target_my set 
	                        sales_id='".$post['sales_name']."',
							qty='".$post['y_qty']."',
							incentive='".$post['y_incentive']."',
							month='".$post['syear']."',
							year='".$post['eyaer']."',
							 where id='".$post['taId']."'";
