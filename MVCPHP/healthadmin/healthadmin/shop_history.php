...
<head>
	...
	<body>
		...
		<div class="main-container">
			...
			//echo ' MONTH(NOW())' ;
			//echo $year= date('Y');								
			 $sql="select db_shop_history.*,db_sales_register.fname,db_shop_register.shop_name from db_shop_history,db_sales_register,db_shop_register where  db_shop_history.sales_id=db_sales_register.id and db_shop_history.shop_id = db_shop_register.id"; 
												...
												if($row['fname'] && $row['shop_name']&& $row['in_time']&& $row['out_time']&& $row['shop_distance']&& $row['shop_diff_time']&& $row['history_date'] != ''){
												 ?>
												<tr>
                                                <?php
												$intime=$row['in_time'];
												$outtime=$row['out_time'];
													  $sql="SELECT TIMEDIFF('$outtime','$intime')";
													...
													<td><?=$row['shop_name'];?></td>
                                                     <td><?=$time?></td>
                                                    <td><?=$row['shop_distance'];?></td>
                                                    <td><?=$row['shop_diff_time'];?></td>
