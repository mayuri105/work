...
<head>
		<title>Admin |Display Material</title>
		<!-- start: META -->
		<meta charset="utf-8" />
				...
				<div class="container">
					...
					<div class="row">
						...
						<ol class="breadcrumb">
								...
								<li class="active">
									 <a href="shop_display.php"> Display Material </a>
								</li>
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allsalesmat=$adminClass->salesmaterialdetail();
													$s=1;
													foreach($allsalesmat as $allsalesmat)
												{	
												 ?>
												<tr>
													<td><?=$s;?></td>
													<td><?=$allsalesmat['shop_name'];?></td>
                                                    <td><?=$allsalesmat['fname'];?></td>
                                                    <td><?=$allsalesmat['materialtype'];?></td>
                                                    <td><?=$allsalesmat['qty'];?></td>
                                                    <td><?=$allsalesmat['added_date'];?></td>
                                                    <td>
													<a data-original-title="Remove" data-placement="top" class="btn btn-xs btn-bricky tooltips"  href="delete.php?amId=<?=$allsalesmat['id'];?>" ><i class="fa fa-times fa fa-white"></i></a>
													</td>									
