...
$SITE_PATH="../health_higeni_webservice/upload/";
				...
				<div class="container">
					...
					<div class="row">
						...
						<ol class="breadcrumb">
								...
								<li class="active">
									 <a href="shop_display.php"> Display Register Shop </a>
								</li>
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allshop=$adminClass->shopdetail();
													$s=1;
													foreach($allshop as $allshop)
													{	
												 ?>
												<tr>
													<td><?=$s;?></td>
													<td><a href="shop_order.php?shopId=<?=$allshop['id'];?>"><?=$allshop['shop_name'];?><a></td>
													<td><?=$allshop['client_name'];?></td>
													<td><?=$allshop['area'];?>&nbsp;<?=$allshop['street'];?>&nbsp;<?=$allshop['country'];?><br><?=$allshop['state'];?>&nbsp;<?=$allshop['city'];?>&nbsp;<?=$allshop['pincode'];?><br><strong>Contact No:</strong><?=$allshop['contactno'];?></td>
                                                    <td><?=$allshop['comment'];?></td>
                                                    <td><?=$allshop['suggestion'];?></td>
                                                    <td><?=$allshop['status'];?></td>
                                                     <td><img src="<?=$SITE_PATH.$allshop['shop_image'];?>" alt ="NO Image" height="50" width="50"></td>
                                                    <td><?=$allshop['added_date'];?></td>
                                                   
													
													<td>
													<a data-original-title="Remove" data-placement="top" class="btn btn-xs btn-bricky tooltips"  href="delete.php?shopId=<?=$allshop['id'];?>" ><i class="fa fa-times fa fa-white"></i></a>
													</td>									
