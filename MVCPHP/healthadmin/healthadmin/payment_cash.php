				...
				<div class="container">
					...
					<div class="row">
						...
						<ol class="breadcrumb">
								...
								<li class="active">
									 <a href="payment_cash.php"> Payment Cash Detail</a>
								</li>
										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allcash=$adminClass->paycashdetail();
													$s=1;
													foreach($allcash as $allcash)
													{	
												 ?>
												<tr>
													<td><?=$s;?></td>
													<td><?=$allcash['fname'];?> </td>
													<td><?=$allcash['shop_name'];?></td>
                                                    <td><?=$allcash['total'];?></td>
                                                    <td><?=$allcash['ammount'];?></td>
                                                    <td><?=$allcash['rammount'];?></td>
                                                     <td><?=$allcash['date'];?></td>
                                                     <td><img src="<?=$SITE_PATH.$allcash['invoice_img'];?>" alt="No Image" height="50" width="50"></td>
                                                    <td><?=$allcash['added_date'];?></td>
                                                   
													
													<td>
													<a data-original-title="Remove" data-placement="top" class="btn btn-xs btn-bricky tooltips"  href="delete.php?cashId=<?=$allcash['id'];?>" ><i class="fa fa-times fa fa-white"></i></a>
													</td>									
