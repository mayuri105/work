										...
										<table class="table table-striped table-bordered table-hover" id="sample-table-2">
											...
											<tbody>
												<?php
													...
													$allorder=$adminClass->orderdetaildaily();
													$s=1;
												...
												<tr>
													...
													<td><a href="ordersales_display.php?oraderId=<?=$allorder['sales_id'];?>"><?=$allorder['sales_name'];?></a> </td>
													<td><?=$allorder['shop_name'];?></td>
													<td><?=$allorder['product_name'];?></td>
                                                    <td><?=$allorder['totalqty'];?></td>
                                                    
                                                    <td><?=$allorder['price'];?></td>
                                                    <td><?=$allorder['grandtot'];?></td>
                                                ...
                                                <?php 
												 $adminClass=new adminClass();
												 $count=$adminClass->ordercount($allorder['order_date']);
												 foreach($count as $allordercount)
												{
													if($allordercount['order_date']==$allorder['order_date'] && $allordercount['sales_id']==$allorder['sales_id']) 		   			 {
										?>
                                                <tr>
													 <td colspan="2"></td>
														<td  style="text-align:right;color:#EEEEEE;background-color:#BA3E2C;"> Order on <?=$allordercount['order_date'];?> &nbsp;</td>
													   <td style="text-align:right;color:#EEEEEE;background-color:#BA3E2C"><?=$allordercount['totalqty'];?></td>
                                                        <td  style="text-align:right;color:#EEEEEE;background-color:#BA3E2C;"> Total  &nbsp;</td>
                                                        <td style="text-align:right;color:#EEEEEE;background-color:#BA3E2C"><?=$allordercount['grandtot'];?></td>
