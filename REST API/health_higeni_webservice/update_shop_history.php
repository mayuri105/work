...
if (isset($_POST['shop_id']) &&isset($_POST['outtime']) && isset($_POST['statusout'])&& isset($_POST['diff_let_log'])&& isset($_POST['shop_diff_time'])&& isset($_POST['shop_distance'])) {
	...
	echo $sql_update="UPDATE db_shop_history set out_time='".$outtime."',statusout='".$statusout."',diff_let_log='".$diff_let_log."',shop_id='".$shop_id."',shop_diff_time='".$shop_diff_time."',shop_distance='".$shop_distance."' WHERE sales_id='".$sales_id."'  and id='".$maxid."' ";
